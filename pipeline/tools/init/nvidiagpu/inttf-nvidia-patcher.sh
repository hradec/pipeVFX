...
nvidia_versions=( '340.108' '390.144' '418.113' '435.21' )
...
nvidia_390xx_b2sum="8ecfa768fb8fe92170ff5b82698a7fb22da8bc557ab2036464bf5650b6fffc7028e25a68e1f5638f6bc171eb45a4aba459465490c7a99aacd36dc769994062e8"
...
./$nvidia_directory/makeself.sh --target-os Linux --target-arch x86_64 $nvidia_directory $nvidia_directory-patched-kernel-5.16.run "NVIDIA driver $nvidia_version patched for kernel 5.16+" ./nvidia-installer
