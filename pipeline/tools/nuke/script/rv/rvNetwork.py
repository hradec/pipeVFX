    ...
    def messageAvailable (self) :
        ...
        try :
            ...
            if (len(data) != 0) :
                ...
                sys.stderr.write ("ERROR: remote host closed connection (1)\n")
                self.sock.close()
                self.connected = False
            ...
            if (    msg[0] == 10054 or 
                    msg[1] == 'Connection reset by peer') :
                sys.stderr.write ("ERROR: remote host closed connection (2)\n")
                self.sock.close()
                self.connected = False
