...
class FovCalculator( nukescripts.PythonPanel ):
    def __init__( self):
        ...
        self.mode = nuke.Enumeration_Knob( 'mode', 'get', modes)
        self.mode.setValue( 'fov' )
        self.mode.setTooltip( 'select which value you want to calculate' )
        self.focal = nuke.Double_Knob( 'focal', 'focal length' )
        ...
        self.apList = nuke.Enumeration_Knob( 'ap', 'aperture', self.apNames )
        ...
        self.hfov = nuke.Double_Knob( 'hfov', 'horizontal fov' )
        ...
        self.vfov = nuke.Double_Knob( 'vfov', 'vertical fov' )
        ...
        self.driveCam = nuke.Boolean_Knob( 'driveCam', 'Drive Existing Camera')
    ...
    def getAps( self ):
        for d in nuke.pluginPath():
            ...
            #apFile = os.path.join( d, '/nukepedia/apertures.txt')
            apFile = d + '/nukepedia/apertures.txt'
