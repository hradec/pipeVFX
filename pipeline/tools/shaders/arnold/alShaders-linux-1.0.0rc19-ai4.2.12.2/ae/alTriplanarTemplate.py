...
class AEalTriplanarTemplate(alShadersTemplate):
	...
	def setup(self):
		...
		self.params["mipMapBias"] = Param("mipMapBias", "Mip map bias", "Biases the lookup into the texture to select a higher or lower mipmap level. Positive numbers select a higher (blurrier) level, negative numbers select a lower (sharper) level.", "int", presets=None)
		...
		self.addControl("mipMapBias", label="Mip map bias", annotation="Biases the lookup into the texture to select a higher or lower mipmap level. Positive numbers select a higher (blurrier) level, negative numbers select a lower (sharper) level.")
