...
class cortex( genericAsset._genericAssetClass ) :
    _whoCanPublish = ['maya','houdini']
    _whoCanImport = []#['maya','nuke','houdini']
    _whoCanOpen = ["maya"]

    def __init__( self ) :
        genericAsset._genericAssetClass.__init__(self, 'cortex')
