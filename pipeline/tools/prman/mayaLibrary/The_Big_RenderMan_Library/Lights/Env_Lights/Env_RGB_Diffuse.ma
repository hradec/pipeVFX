...
//Last modified: Tue, Apr 14, 2015 04:12:40 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode place2dTexture -n "_place2dTexture10";
	setAttr ".of" -type "float2" 0 -0.15000001 ;
createNode place2dTexture -n "_place2dTexture13";
createNode layeredTexture -n "_RGBLighting";
	addAttr -ci true -sn "nts" -ln "notes" -dt "string";
	setAttr -s 4 ".cs";
...
createNode place2dTexture -n "_place2dTexture12";
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -av -cb on ".gh";
	setAttr -cb on ".sd";
connectAttr "_RGBLighting.oc" "Env_RGB_Diffuse_Shape.lightcolor";
connectAttr "_place2dTexture13.o" "_ramp_bounce.uv";
connectAttr "_place2dTexture13.ofs" "_ramp_bounce.fs";
connectAttr "_ramp_Red.oa" "_RGBLighting.cs[4].a";
connectAttr "_ramp_Blue.oa" "_RGBLighting.cs[9].a";
connectAttr "_ramp_Green.oa" "_RGBLighting.cs[11].a";
connectAttr "_ramp_bounce.oc" "_RGBLighting.cs[13].c";
connectAttr "_place2dTexture10.o" "_ramp_Red.uv";
connectAttr "_place2dTexture10.ofs" "_ramp_Red.fs";
connectAttr "_place2dTexture12.o" "_ramp_Blue.uv";
connectAttr "_place2dTexture12.ofs" "_ramp_Blue.fs";
connectAttr "_place2dTexture11.o" "_ramp_Green.uv";
connectAttr "_place2dTexture11.ofs" "_ramp_Green.fs";
connectAttr ":defaultRenderGlobals.msg" "mtorPartition.rgcnx";
connectAttr "_RGBLighting.msg" ":defaultTextureList1.tx" -na;
connectAttr "_ramp_Blue.msg" ":defaultTextureList1.tx" -na;
connectAttr "_ramp_bounce.msg" ":defaultTextureList1.tx" -na;
connectAttr "_ramp_Red.msg" ":defaultTextureList1.tx" -na;
connectAttr "_ramp_Green.msg" ":defaultTextureList1.tx" -na;
connectAttr "Env_RGB_Diffuse_Shape.ltd" ":lightList1.l" -na;
connectAttr "_place2dTexture10.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "_place2dTexture11.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "_place2dTexture12.msg" ":defaultRenderUtilityList1.u" -na;
