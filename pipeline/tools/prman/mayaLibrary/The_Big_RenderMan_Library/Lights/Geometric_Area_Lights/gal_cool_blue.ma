...
//Name: gal_cool_blue.ma
//Last modified: Tue, Apr 14, 2015 05:05:48 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode RMSGeoAreaLight -n "GAL_Cool_BlueShape" -p "GAL_Cool_Blue";
...
createNode ramp -n "rampGAL_Cool_BlueShape";
	setAttr ".in" 3;
	setAttr -s 3 ".cel";
	setAttr ".cel[0].ep" 1;
	...
	setAttr ".cel[2].ep" 0.16500000655651093;
	setAttr ".cel[2].ec" -type "float3" 0 0 0.77611965 ;
createNode place2dTexture -n "place2dTextureGAL_Cool_BlueShape";
createNode displayLayer -n "cool_blue1";
	setAttr ".id" 2;
	setAttr ".c" 6;
	setAttr ".do" 2;
select -ne :time1;
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -av -cb on ".gh";
	setAttr -cb on ".sd";
connectAttr "cool_blue1.di" "GAL_Cool_Blue.do";
connectAttr "rampGAL_Cool_BlueShape.oc" "GAL_Cool_BlueShape.lightcolor";
connectAttr "place2dTextureGAL_Cool_BlueShape.o" "rampGAL_Cool_BlueShape.uv";
connectAttr "place2dTextureGAL_Cool_BlueShape.ofs" "rampGAL_Cool_BlueShape.fs";
connectAttr "rampGAL_Cool_BlueShape.msg" ":defaultTextureList1.tx" -na;
connectAttr "GAL_Cool_BlueShape.ltd" ":lightList1.l" -na;
connectAttr "place2dTextureGAL_Cool_BlueShape.msg" ":defaultRenderUtilityList1.u"
		 -na;
connectAttr "GAL_Cool_Blue.iog" ":defaultLightSet.dsm" -na;
// End of gal_cool_blue.ma
