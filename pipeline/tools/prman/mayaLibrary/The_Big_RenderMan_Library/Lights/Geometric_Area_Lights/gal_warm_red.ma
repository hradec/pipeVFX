...
//Name: gal_warm_red.ma
//Last modified: Tue, Apr 14, 2015 05:03:18 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -n "GAL_Cool_Blue";
...
createNode RMSGeoAreaLight -n "GAL_Warm_RedShape" -p "GAL_Cool_Blue";
...
createNode ramp -n "rampGAL_Warm_RedShape";
	setAttr ".in" 3;
	setAttr -s 3 ".cel";
	...
	setAttr ".cel[2].ep" 0.14000000059604645;
	setAttr ".cel[2].ec" -type "float3" 0.62687111 0 0 ;
createNode place2dTexture -n "place2dTextureGAL_Warm_RedShape";
...
createNode displayLayer -n "_cool_blue";
	setAttr ".id" 2;
	setAttr ".do" 2;
select -ne :time1;
	setAttr -av -k on ".cch";
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -av -cb on ".gh";
	setAttr -cb on ".sd";
connectAttr "_cool_blue.di" "GAL_Cool_Blue.do";
connectAttr "rampGAL_Warm_RedShape.oc" "GAL_Warm_RedShape.lightcolor";
connectAttr "place2dTextureGAL_Warm_RedShape.o" "rampGAL_Warm_RedShape.uv";
connectAttr "place2dTextureGAL_Warm_RedShape.ofs" "rampGAL_Warm_RedShape.fs";
connectAttr ":defaultRenderGlobals.msg" "mtorPartition.rgcnx";
connectAttr "rampGAL_Warm_RedShape.msg" ":defaultTextureList1.tx" -na;
connectAttr "GAL_Warm_RedShape.ltd" ":lightList1.l" -na;
connectAttr "place2dTextureGAL_Warm_RedShape.msg" ":defaultRenderUtilityList1.u"
		 -na;
connectAttr "GAL_Cool_Blue.iog" ":defaultLightSet.dsm" -na;
// End of gal_warm_red.ma
