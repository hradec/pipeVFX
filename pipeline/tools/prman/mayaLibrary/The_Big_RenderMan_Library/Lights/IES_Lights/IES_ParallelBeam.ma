...
//Name: IES_ParallelBeam.ma
//Last modified: Wed, Feb 25, 2015 01:47:13 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -n "IES_ParallelBeam" -p "group1";
...
createNode RMSGeoAreaLight -n "IES_ParallelBeamShape" -p "IES_ParallelBeam";
	addAttr -ci true -sn "nts" -ln "notes" -dt "string";
	setAttr -k off ".v";
	setAttr ".intensity" 12.5;
	setAttr ".temperature" -1;
	setAttr ".iesprofile" -type "string" "sourceimages/IES_profiles/ParallelBeam.ies";
	setAttr ".sides" yes;
...
connectAttr "IES_ParallelBeamShape.ltd" ":lightList1.l" -na;
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
connectAttr "IES_ParallelBeam.iog" ":defaultLightSet.dsm" -na;
// End of IES_ParallelBeam.ma
