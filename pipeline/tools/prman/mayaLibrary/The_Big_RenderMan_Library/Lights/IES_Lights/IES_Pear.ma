...
//Name: IES_Pear.ma
//Last modified: Wed, Feb 25, 2015 01:47:35 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -n "IES_Pear" -p "group1";
...
createNode RMSGeoAreaLight -n "IES_PearShape" -p "IES_Pear";
	addAttr -ci true -sn "nts" -ln "notes" -dt "string";
	setAttr -k off ".v";
	setAttr ".intensity" 14.5;
	setAttr ".temperature" -1;
	setAttr ".iesprofile" -type "string" "sourceimages/IES_profiles/Pear.ies";
	setAttr ".sides" yes;
...
connectAttr "IES_PearShape.ltd" ":lightList1.l" -na;
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
connectAttr "IES_Pear.iog" ":defaultLightSet.dsm" -na;
// End of IES_Pear.ma
