...
//Name: IES_Overhead.ma
//Last modified: Wed, Feb 25, 2015 01:46:55 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -n "IES_Overhead" -p "group1";
...
createNode RMSGeoAreaLight -n "IES_OverheadShape" -p "IES_Overhead";
	addAttr -ci true -sn "nts" -ln "notes" -dt "string";
	setAttr -k off ".v";
	setAttr ".intensity" 10;
	setAttr ".temperature" -1;
	setAttr ".iesprofile" -type "string" "sourceimages/IES_profiles/Overhead.IES";
	setAttr ".sides" yes;
...
connectAttr "IES_OverheadShape.ltd" ":lightList1.l" -na;
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
connectAttr "IES_Overhead.iog" ":defaultLightSet.dsm" -na;
// End of IES_Overhead.ma
