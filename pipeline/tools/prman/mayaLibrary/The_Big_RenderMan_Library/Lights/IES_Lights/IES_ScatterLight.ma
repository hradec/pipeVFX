...
//Name: IES_ScatterLight.ma
//Last modified: Wed, Feb 25, 2015 01:48:41 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -n "IES_ScatterLight" -p "group1";
...
createNode RMSGeoAreaLight -n "IES_ScatterLightShape" -p "IES_ScatterLight";
	addAttr -ci true -sn "nts" -ln "notes" -dt "string";
	setAttr -k off ".v";
	setAttr ".intensity" 15;
	setAttr ".temperature" -1;
	setAttr ".iesprofile" -type "string" "sourceimages/IES_profiles/ScatterLight.IES";
	setAttr ".sides" yes;
...
connectAttr "IES_ScatterLightShape.ltd" ":lightList1.l" -na;
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
connectAttr "IES_ScatterLight.iog" ":defaultLightSet.dsm" -na;
// End of IES_ScatterLight.ma
