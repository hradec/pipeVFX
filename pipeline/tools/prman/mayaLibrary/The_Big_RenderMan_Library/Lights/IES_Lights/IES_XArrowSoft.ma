...
//Name: IES_XArrowSoft.ma
//Last modified: Wed, Feb 25, 2015 01:53:08 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode RMSGeoAreaLight -n "IES_XArrowDiffuseShape" -p "IES_XArrowDiffuse";
	...
	setAttr ".iesprofile" -type "string" "sourceimages/IES_profiles/XArrowSoft.IES";
	setAttr ".sides" yes;
