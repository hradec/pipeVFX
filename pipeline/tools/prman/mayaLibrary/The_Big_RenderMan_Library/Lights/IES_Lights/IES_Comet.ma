...
//Name: IES_Comet.ma
//Last modified: Wed, Feb 25, 2015 01:45:43 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -n "IES_Comet" -p "group1";
...
createNode RMSGeoAreaLight -n "IES_CometShape" -p "IES_Comet";
	setAttr -k off ".v";
	setAttr ".intensity" 13.5;
	setAttr ".temperature" -1;
	setAttr ".iesprofile" -type "string" "sourceimages/IES_profiles/Comet.IES";
	setAttr ".sides" yes;
...
connectAttr "IES_CometShape.ltd" ":lightList1.l" -na;
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
connectAttr "IES_Comet.iog" ":defaultLightSet.dsm" -na;
// End of IES_Comet.ma
