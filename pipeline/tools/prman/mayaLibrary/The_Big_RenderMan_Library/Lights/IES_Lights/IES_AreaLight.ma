...
//Name: IES_AreaLight.ma
//Last modified: Wed, Feb 25, 2015 01:44:50 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -n "IES_AreaLight" -p "group1";
...
createNode RMSGeoAreaLight -n "IES_AreaLightShape" -p "IES_AreaLight";
	setAttr -k off ".v";
	setAttr ".intensity" 15;
	setAttr ".temperature" -1;
	setAttr ".iesprofile" -type "string" "sourceimages/IES_profiles/AreaLight.ies";
	setAttr ".sides" yes;
...
connectAttr "IES_AreaLightShape.ltd" ":lightList1.l" -na;
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
connectAttr "IES_AreaLight.iog" ":defaultLightSet.dsm" -na;
// End of IES_AreaLight.ma
