...
//Name: IES_XArrowDiffuse.ma
//Last modified: Wed, Feb 25, 2015 01:51:16 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -n "IES_XArrowDiffuse" -p "group1";
...
createNode RMSGeoAreaLight -n "IES_XArrowDiffuseShape" -p "IES_XArrowDiffuse";
	...
	setAttr ".iesprofile" -type "string" "sourceimages/IES_profiles/XArrowDiffuse.IES";
	setAttr ".sides" yes;
...
connectAttr "IES_XArrowDiffuseShape.ltd" ":lightList1.l" -na;
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
connectAttr "IES_XArrowDiffuse.iog" ":defaultLightSet.dsm" -na;
// End of IES_XArrowDiffuse.ma
