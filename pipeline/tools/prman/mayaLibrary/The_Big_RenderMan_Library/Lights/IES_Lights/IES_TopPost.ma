...
//Name: IES_TopPost.ma
//Last modified: Wed, Feb 25, 2015 01:50:27 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -n "IES_TopPost" -p "group1";
...
createNode RMSGeoAreaLight -n "IES_TopPostShape" -p "IES_TopPost";
	...
	setAttr ".iesprofile" -type "string" "sourceimages/IES_profiles/TopPost.IES";
	setAttr ".sides" yes;
...
connectAttr "IES_TopPostShape.ltd" ":lightList1.l" -na;
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
connectAttr "IES_TopPost.iog" ":defaultLightSet.dsm" -na;
// End of IES_TopPost.ma
