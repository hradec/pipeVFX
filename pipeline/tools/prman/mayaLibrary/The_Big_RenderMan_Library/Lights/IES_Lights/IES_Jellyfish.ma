...
//Name: IES_Jellyfish.ma
//Last modified: Wed, Feb 25, 2015 01:46:29 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -n "IES_Jellyfish" -p "group1";
...
createNode RMSGeoAreaLight -n "IES_JellyfishShape" -p "IES_Jellyfish";
	setAttr -k off ".v";
	setAttr ".intensity" 14;
	setAttr ".temperature" -1;
	setAttr ".iesprofile" -type "string" "sourceimages/IES_profiles/JellyFish.IES";
	setAttr ".sides" yes;
...
connectAttr "IES_JellyfishShape.ltd" ":lightList1.l" -na;
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
connectAttr "IES_Jellyfish.iog" ":defaultLightSet.dsm" -na;
// End of IES_Jellyfish.ma
