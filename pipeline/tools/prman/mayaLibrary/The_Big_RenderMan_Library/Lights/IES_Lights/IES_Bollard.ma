...
//Name: IES_Bollard.ma
//Last modified: Wed, Feb 25, 2015 01:45:19 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -n "IES_Bollard" -p "group1";
...
createNode RMSGeoAreaLight -n "IES_BollardShape" -p "IES_Bollard";
	setAttr -k off ".v";
	setAttr ".intensity" 15;
	setAttr ".temperature" -1;
	setAttr ".iesprofile" -type "string" "sourceimages/IES_profiles/Bollard.IES";
	setAttr ".sides" yes;
...
connectAttr "IES_BollardShape.ltd" ":lightList1.l" -na;
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
connectAttr "IES_Bollard.iog" ":defaultLightSet.dsm" -na;
// End of IES_Bollard.ma
