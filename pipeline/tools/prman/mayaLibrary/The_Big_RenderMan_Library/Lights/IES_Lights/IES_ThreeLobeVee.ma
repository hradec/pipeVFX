...
//Name: IES_ThreeLobeVee.ma
//Last modified: Wed, Feb 25, 2015 01:49:54 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -n "IES_ThreeLobeVee" -p "group1";
...
createNode RMSGeoAreaLight -n "IES_ThreeLobeVeeShape" -p "IES_ThreeLobeVee";
	addAttr -ci true -sn "nts" -ln "notes" -dt "string";
	setAttr -k off ".v";
	setAttr ".intensity" 11.5;
	setAttr ".temperature" -1;
	setAttr ".iesprofile" -type "string" "sourceimages/IES_profiles/ThreeLobeVee.ies";
	setAttr ".sides" yes;
...
connectAttr "IES_ThreeLobeVeeShape.ltd" ":lightList1.l" -na;
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
connectAttr "IES_ThreeLobeVee.iog" ":defaultLightSet.dsm" -na;
// End of IES_ThreeLobeVee.ma
