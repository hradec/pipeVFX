...
//Name: IES_TightFocused.ma
//Last modified: Wed, Feb 25, 2015 01:50:11 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -n "IES_TightFocused" -p "group1";
...
createNode RMSGeoAreaLight -n "IES_TightFocusedShape" -p "IES_TightFocused";
	addAttr -ci true -sn "nts" -ln "notes" -dt "string";
	setAttr -k off ".v";
	setAttr ".intensity" 12.5;
	setAttr ".temperature" -1;
	setAttr ".iesprofile" -type "string" "sourceimages/IES_profiles/TightFocused.IES";
	setAttr ".sides" yes;
...
connectAttr "IES_TightFocusedShape.ltd" ":lightList1.l" -na;
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
connectAttr "IES_TightFocused.iog" ":defaultLightSet.dsm" -na;
// End of IES_TightFocused.ma
