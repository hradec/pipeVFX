...
//Name: IES_ThreeLobeUmbrella.ma
//Last modified: Wed, Feb 25, 2015 01:49:38 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -n "IES_ThreeLobeUmbrella" -p "group1";
...
createNode RMSGeoAreaLight -n "IES_ThreeLobeUmbrellaShape" -p "IES_ThreeLobeUmbrella";
	addAttr -ci true -sn "nts" -ln "notes" -dt "string";
	setAttr -k off ".v";
	setAttr ".intensity" 12.5;
	setAttr ".temperature" -1;
	setAttr ".iesprofile" -type "string" "sourceimages/IES_profiles/ThreeLobeUmbrella.ies";
	setAttr ".sides" yes;
...
createNode RenderMan -s -n "renderManGlobals";
	...
	setAttr -k on ".rman__riopt__Format_resolution" -type "long2" 1024 1024 ;
...
connectAttr "IES_ThreeLobeUmbrellaShape.ltd" ":lightList1.l" -na;
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
connectAttr "IES_ThreeLobeUmbrella.iog" ":defaultLightSet.dsm" -na;
// End of IES_ThreeLobeUmbrella.ma
