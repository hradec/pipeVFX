...
//Name: IES_Medium_Scatter.ma
//Last modified: Wed, Feb 25, 2015 01:46:37 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -n "IES_Medium_Scatter" -p "group1";
...
createNode RMSGeoAreaLight -n "IES_Medium_ScatterShape" -p "IES_Medium_Scatter";
	addAttr -ci true -sn "nts" -ln "notes" -dt "string";
	setAttr -k off ".v";
	setAttr ".intensity" 13;
	setAttr ".temperature" -1;
	setAttr ".iesprofile" -type "string" "sourceimages/IES_profiles/MediumScatter.ies";
	setAttr ".sides" yes;
...
connectAttr "IES_Medium_ScatterShape.ltd" ":lightList1.l" -na;
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
connectAttr "IES_Medium_Scatter.iog" ":defaultLightSet.dsm" -na;
// End of IES_Medium_Scatter.ma
