...
//Name: IES_Round.ma
//Last modified: Wed, Feb 25, 2015 01:47:55 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -n "IES_Round" -p "group1";
...
createNode RMSGeoAreaLight -n "IES_RoundShape" -p "IES_Round";
	addAttr -ci true -sn "nts" -ln "notes" -dt "string";
	setAttr -k off ".v";
	setAttr ".intensity" 9.5;
	setAttr ".temperature" -1;
	setAttr ".iesprofile" -type "string" "sourceimages/IES_profiles/Round.IES";
	setAttr ".sides" yes;
...
connectAttr "IES_RoundShape.ltd" ":lightList1.l" -na;
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
connectAttr "IES_Round.iog" ":defaultLightSet.dsm" -na;
// End of IES_Round.ma
