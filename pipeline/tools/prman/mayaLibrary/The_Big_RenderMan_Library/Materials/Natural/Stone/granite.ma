...
//Name: granite.ma
//Last modified: Sun, Apr 05, 2015 03:07:45 AM
//Codeset: 1252
requires maya "2014";
...
createNode PxrLMDiffuse -n "PxrLMDiffuseGranite";
	setAttr ".backColor" -type "float3" 0.85392541 0.85392541 0.85392541 ;
...
createNode granite -n "granite1";
	setAttr ".ail" yes;
	setAttr ".c2" -type "float3" 0.15335657 0.219 0.1095 ;
	setAttr ".c3" -type "float3" 1 0.92205691 0.76102847 ;
	setAttr ".cs" 0.090225562453269958;
	setAttr ".mr" 0.83458644151687622;
	setAttr ".s" 0.72932332754135132;
	setAttr ".th" 0.45112782716751099;
createNode marble -n "marble3";
	setAttr ".fc" -type "float3" 0.74699998 0.62936026 0.41981402 ;
	setAttr ".vc" -type "float3" 0.71799999 0.57931727 0.28648198 ;
	setAttr ".vw" 0.33082705736160278;
	setAttr ".di" 1;
	setAttr ".c" 0;
	setAttr ".a" 1.263157844543457;
createNode PxrLMLayer -n "PxrLMLayer2";
	...
	setAttr ".clearcoatRoughness" 0.059999998658895493;
	setAttr ".clearcoatThickness" 0.40000000596046448;
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
	setAttr -av -k on ".nds";
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -av -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "granite1.oc" "PxrLMDiffuseGranite.frontColor";
connectAttr "granite1.oa" "PxrLMDiffuseGranite.roughness";
connectAttr "PxrLMLayer2.result" "PxrLMDiffuseGranite.lmlayer";
connectAttr ":defaultRenderGlobals.msg" "mtorPartition.rgcnx";
connectAttr "place3dTexture14.wim" "granite1.pm";
connectAttr "marble3.oc" "granite1.fc";
connectAttr "place3dTexture18.wim" "marble3.pm";
connectAttr "PxrLMDiffuseGranite.msg" ":defaultShaderList1.s" -na;
