...
//Name: sand.ma
//Last modified: Sat, Mar 14, 2015 04:41:47 AM
//Codeset: 1252
requires maya "2014";
...
createNode PxrLMPlastic -n "PxrLMPlasticSand";
	setAttr ".diffuseRoughness" 0.46067416667938232;
	setAttr ".translucence" 0.078651688992977142;
	setAttr ".diffuseNn" -type "float3" 1 1 1 ;
	setAttr ".specularColor" -type "float3" 0.84269476 0.84269476 0.84269476 ;
...
createNode partition -n "mtorPartition";
	...
	setAttr ".sd" -type "string" "#\n# generated by slim for Harsh at Sat Mar 14 4:41:45 AM China Standard Time 2015\n#\nslim 2 TOR slim {\n}\n";
	setAttr ".sr" -type "string" "";
createNode ramp -n "sand:ramp1";
	setAttr ".t" 1;
	setAttr ".in" 2;
	setAttr -s 2 ".cel";
	setAttr ".cel[0].ep" 0;
	setAttr ".cel[2].ep" 1;
createNode place2dTexture -n "sand:place2dTexture2";
createNode PxrFacingRatio -n "PxrFacingRatio1";
	setAttr ".gamma" 2.5842697620391846;
createNode noise -n "sand:noise2";
	setAttr ".cg" -type "float3" 0.98290992 0.95036238 0.86199743 ;
	setAttr ".co" -type "float3" 0.85000384 0.61330587 0.20572214 ;
	setAttr ".a" 0.25619998574256897;
	setAttr ".ra" 0.95866000652313232;
	setAttr ".dm" 5;
	setAttr ".fq" 200;
	setAttr ".nty" 4;
createNode place2dTexture -n "sand:place2dTexture3";
	setAttr ".re" -type "float2" 5 5 ;
createNode noise -n "sand:noise1";
	setAttr ".cg" -type "float3" 0.95832759 0.78019381 0.47339588 ;
	setAttr ".co" -type "float3" 0.86666667 0.61734951 0.39444572 ;
	setAttr ".a" 0.44629999995231628;
	setAttr ".ra" 0.87603998184204102;
	setAttr ".dm" 5;
	setAttr ".fq" 200;
	setAttr ".fr" 2.2646000385284424;
	setAttr ".nty" 3;
createNode PxrBump -n "PxrBump7";
	setAttr ".scale" 0.0099999997764825821;
createNode noise -n "sand:noise3";
	setAttr ".ail" yes;
	setAttr ".ag" 0.5;
	setAttr ".fq" 100;
	setAttr ".nty" 3;
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -av -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "sand:ramp1.oc" "PxrLMPlasticSand.diffuseColor";
connectAttr "PxrBump7.resultN" "PxrLMPlasticSand.specularNn";
connectAttr ":defaultRenderGlobals.msg" "mtorPartition.rgcnx";
connectAttr "sand:place2dTexture2.o" "sand:ramp1.uv";
connectAttr "PxrFacingRatio1.resultF" "sand:ramp1.u";
connectAttr "sand:place2dTexture2.ofs" "sand:ramp1.fs";
connectAttr "sand:noise2.oc" "sand:ramp1.cel[0].ec";
connectAttr "sand:noise1.oc" "sand:ramp1.cel[2].ec";
connectAttr "sand:place2dTexture3.o" "sand:noise2.uv";
connectAttr "sand:place2dTexture3.ofs" "sand:noise2.fs";
connectAttr "sand:place2dTexture3.o" "sand:noise1.uv";
connectAttr "sand:place2dTexture3.ofs" "sand:noise1.fs";
connectAttr "sand:noise3.oa" "PxrBump7.inputBump";
connectAttr "sand:place2dTexture3.o" "sand:noise3.uv";
connectAttr "sand:place2dTexture3.ofs" "sand:noise3.fs";
connectAttr "PxrLMPlasticSand.msg" ":defaultShaderList1.s" -na;
connectAttr "sand:ramp1.msg" ":defaultTextureList1.tx" -na;
connectAttr "sand:noise1.msg" ":defaultTextureList1.tx" -na;
connectAttr "sand:noise2.msg" ":defaultTextureList1.tx" -na;
connectAttr "sand:noise3.msg" ":defaultTextureList1.tx" -na;
connectAttr "PxrFacingRatio1.msg" ":defaultTextureList1.tx" -na;
connectAttr "PxrBump7.msg" ":defaultTextureList1.tx" -na;
connectAttr "sand:place2dTexture2.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "sand:place2dTexture3.msg" ":defaultRenderUtilityList1.u" -na;
// End of sand.ma
