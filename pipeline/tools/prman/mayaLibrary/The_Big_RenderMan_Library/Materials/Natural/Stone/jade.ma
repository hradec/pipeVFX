...
//Name: jade.ma
//Last modified: Sat, Apr 04, 2015 06:53:09 AM
//Codeset: 1252
requires maya "2014";
...
createNode PxrLMSubsurface -n "PxrLMSubsurfaceJade";
	setAttr ".nearWeight" 0.71910113096237183;
	setAttr ".midWeight" 1;
	setAttr ".midLength" 5;
	setAttr ".farColor" -type "float3" 0.56913102 0.84269476 0.18455787 ;
	setAttr ".farWeight" 1;
	setAttr ".specularColor" -type "float3" 0.57303733 0.57303733 0.57303733 ;
	setAttr ".specularRoughness" 0.13483145833015442;
	setAttr ".clearcoatColor" -type "float3" 0.61797512 0.61797512 0.61797512 ;
	setAttr ".clearcoatEta" 1.3600000143051147;
...
createNode cloud -n "cloud2";
	setAttr ".ail" yes;
	setAttr ".c" 0.12030075490474701;
	setAttr ".tr" 0.84962403774261475;
	setAttr ".ct" 0.19847328960895538;
	setAttr ".et" 1.0687023401260376;
	setAttr ".r" -type "float3" 2 1 1 ;
	setAttr ".a" 1.7175573110580444;
	setAttr ".ra" 0.70992368459701538;
createNode PxrRemap -n "PxrRemap10";
	setAttr ".outputMin" 0.80000001192092896;
	setAttr ".outputMax" 4;
createNode marble -n "marble2";
	setAttr ".fc" -type "float3" 0.63499999 1 0.71702754 ;
	setAttr ".vc" -type "float3" 0.56700003 1 0.66429508 ;
	setAttr ".vw" 0.21374045312404633;
	setAttr ".di" 0.49618321657180786;
	setAttr ".c" 0;
	setAttr ".a" 1.3969465494155884;
	setAttr ".ra" 0.63358777761459351;
createNode marble -n "marble1";
	setAttr ".fc" -type "float3" 0.67843139 0.96946669 0.54483861 ;
	setAttr ".vc" -type "float3" 0 0.8091554 0.40006104 ;
	setAttr ".vw" 0.053435113281011581;
	setAttr ".di" 0.74809157848358154;
	setAttr ".c" 0;
	setAttr ".a" 1.4774435758590698;
	setAttr ".ra" 0.64885497093200684;
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
	setAttr -av -k on ".nds";
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -av -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "PxrRemap9.resultR" "PxrLMSubsurfaceJade.farLength";
connectAttr "PxrRemap10.resultR" "PxrLMSubsurfaceJade.nearLength";
connectAttr "marble1.oc" "PxrLMSubsurfaceJade.midColor";
connectAttr "marble2.oc" "PxrLMSubsurfaceJade.nearColor";
connectAttr ":defaultRenderGlobals.msg" "mtorPartition.rgcnx";
connectAttr "cloud2.oc" "PxrRemap9.inputRGB";
connectAttr "place3dTexture15.wim" "cloud2.pm";
connectAttr "marble2.oa" "PxrRemap10.inputRGBr";
connectAttr "marble2.oa" "PxrRemap10.inputRGBg";
connectAttr "marble2.oa" "PxrRemap10.inputRGBb";
connectAttr "place3dTexture17.wim" "marble2.pm";
connectAttr "place3dTexture16.wim" "marble1.pm";
connectAttr "PxrLMSubsurfaceJade.msg" ":defaultShaderList1.s" -na;
...
connectAttr "PxrRemap10.msg" ":defaultTextureList1.tx" -na;
