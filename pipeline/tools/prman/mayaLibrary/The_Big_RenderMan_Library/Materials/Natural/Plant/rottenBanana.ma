...
//Name: rottenBanana.ma
//Last modified: Sat, Apr 04, 2015 08:49:52 PM
//Codeset: 1252
requires maya "2014";
...
createNode PxrLMPlastic -n "PxrLMPlasticRottenBanana";
	setAttr ".diffuseRoughness" 0.21348313987255096;
	setAttr ".sheen" -type "float3" 0.38202488 0.38202488 0.38202488 ;
	setAttr ".specularRoughness" 0.38202247023582458;
...
createNode PxrRemap -n "PxrRemap5";
	...
	setAttr ".gain" -type "float3" 0.24719615 0.24719615 0.24719615 ;
createNode solidFractal -n "solidFractal2";
	setAttr ".th" 0.3684210479259491;
	setAttr ".fr" 2.4887218475341797;
	setAttr ".an" yes;
	setAttr ".ti" 0.21804511547088623;
createNode volumeNoise -n "volumeNoise1";
	setAttr ".i" yes;
	setAttr ".ail" yes;
	setAttr ".fr" 2.3053436279296875;
	setAttr ".d" 0.35114502906799316;
	setAttr ".sp" 0.78625953197479248;
	setAttr ".sr" 0.8320610523223877;
createNode PxrRemap -n "PxrRemap3";
	setAttr ".bias" -type "float3" 0.50562292 0.50562292 0.50562292 ;
	setAttr ".gain" -type "float3" 0.33707181 0.33707181 0.33707181 ;
createNode solidFractal -n "solidFractal1";
	setAttr ".cg" -type "float3" 0.96946669 0.96946669 0.96946669 ;
	setAttr ".a" 0.88549619913101196;
	setAttr ".th" 0.40000000596046448;
	setAttr ".r" -type "float3" 2 2 2 ;
	setAttr ".d" -type "float2" 0 12 ;
	setAttr ".fr" 2.0305342674255371;
	setAttr ".an" yes;
	setAttr ".ti" 0.19083969295024872;
createNode ramp -n "ramp4";
	setAttr ".in" 4;
	setAttr -s 4 ".cel";
	setAttr ".cel[0].ep" 0;
	setAttr ".cel[0].ec" -type "float3" 0.51225173 0.54500002 0.12862 ;
	setAttr ".cel[1].ep" 0.19499999284744263;
	setAttr ".cel[1].ec" -type "float3" 0.89899999 0.67710185 0.12136499 ;
	setAttr ".cel[2].ep" 1;
	setAttr ".cel[2].ec" -type "float3" 0.89899999 0.73292375 0.13125402 ;
	setAttr ".cel[3].ep" 0.625;
	setAttr ".cel[3].ec" -type "float3" 0.815 0.69538987 0.054604977 ;
	setAttr ".uw" 0.13008129596710205;
	setAttr ".vw" 0.073170728981494904;
	setAttr ".n" 0.019999999552965164;
createNode PxrFacingRatio -n "PxrFacingRatio1";
createNode stucco -n "stucco3";
	setAttr ".sh" 10.526315689086914;
	setAttr ".c1" -type "float3" 0.24060425 0.081666283 0.014908064 ;
	setAttr ".c2" -type "float3" 0.12030213 0.037445638 0.0026550698 ;
...
createNode PxrBlend -n "PxrBlend4";
	...
	setAttr ".bottomRGB" -type "float3" 0.17978179 0.17978179 0.17978179 ;
createNode PxrToFloat -n "PxrToFloat5";
createNode PxrBlend -n "PxrBlend5";
	setAttr ".topRGB" -type "float3" 0.40450141 0.40450141 0.40450141 ;
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
	setAttr -av -k on ".nds";
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -av -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "PxrBlend2.resultRGB" "PxrLMPlasticRottenBanana.diffuseColor";
connectAttr "PxrBump4.resultN" "PxrLMPlasticRottenBanana.diffuseNn";
connectAttr "PxrBump4.resultN" "PxrLMPlasticRottenBanana.specularNn";
connectAttr "PxrBlend4.resultRGB" "PxrLMPlasticRottenBanana.specularColor";
connectAttr "PxrToFloat5.resultF" "PxrLMPlasticRottenBanana.translucence";
connectAttr ":defaultRenderGlobals.msg" "mtorPartition.rgcnx";
connectAttr "PxrToFloat3.resultF" "PxrBlend2.topA";
connectAttr "ramp4.oc" "PxrBlend2.topRGB";
connectAttr "stucco3.oc" "PxrBlend2.bottomRGB";
connectAttr "PxrBlend1.resultRGB" "PxrToFloat3.input";
connectAttr "PxrRemap4.resultRGB" "PxrBlend1.topRGB";
connectAttr "PxrRemap3.resultRGB" "PxrBlend1.bottomRGB";
connectAttr "PxrBlend3.resultRGB" "PxrRemap4.inputRGB";
connectAttr "PxrToFloat4.resultF" "PxrBlend3.topA";
connectAttr "volumeNoise1.oc" "PxrBlend3.topRGB";
connectAttr "PxrRemap5.resultRGB" "PxrToFloat4.input";
connectAttr "solidFractal2.oc" "PxrRemap5.inputRGB";
connectAttr "place3dTexture8.wim" "solidFractal2.pm";
connectAttr "place3dTexture6.wim" "volumeNoise1.pm";
connectAttr "solidFractal1.oc" "PxrRemap3.inputRGB";
connectAttr "place3dTexture7.wim" "solidFractal1.pm";
connectAttr "PxrFacingRatio1.resultF" "ramp4.u";
connectAttr "PxrFacingRatio1.resultF" "ramp4.v";
connectAttr "place3dTexture9.wim" "stucco3.pm";
connectAttr "PxrToFloat3.resultF" "PxrBump4.inputBump";
connectAttr "PxrToFloat3.resultF" "PxrBlend4.topA";
connectAttr "PxrBlend5.resultRGB" "PxrToFloat5.input";
connectAttr "PxrToFloat3.resultF" "PxrBlend5.topA";
connectAttr "PxrLMPlasticRottenBanana.msg" ":defaultShaderList1.s" -na;
...
connectAttr "PxrFacingRatio1.msg" ":defaultTextureList1.tx" -na;
