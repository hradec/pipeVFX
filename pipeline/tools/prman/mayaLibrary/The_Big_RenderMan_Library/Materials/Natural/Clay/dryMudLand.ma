...
//Name: dryMudLand.ma
//Last modified: Sat, Mar 14, 2015 06:06:01 AM
//Codeset: 1252
requires maya "2014";
...
createNode PxrLMDiffuse -n "PxrLMDiffuseMudDry";
...
createNode partition -n "mtorPartition";
	...
	setAttr ".sd" -type "string" "#\n# generated by slim for Harsh at Sat Mar 14 6:05:59 AM China Standard Time 2015\n#\nslim 2 TOR slim {\n}\n";
	setAttr ".sr" -type "string" "";
createNode PxrBlend -n "PxrBlend8";
	setAttr ".operation" 23;
	setAttr ".bottomRGB" -type "float3" 0.53899997 0.40586698 0.27273402 ;
...
createNode stucco -n "stucco4";
	setAttr ".c1" -type "float3" 0.917 0.78623092 0.54653198 ;
	setAttr ".c2" -type "float3" 0.51099998 0.41640532 0.241192 ;
createNode PxrBump -n "PxrBump11";
createNode PxrToFloat -n "PxrToFloat9";
	setAttr ".mode" 3;
createNode PxrBlend -n "PxrBlend9";
	setAttr ".operation" 18;
	setAttr ".topA" 0.21348313987255096;
createNode volumeNoise -n "volumeNoise_for_bump";
	setAttr ".i" yes;
	setAttr ".ail" yes;
	setAttr ".a" 0.58015269041061401;
	setAttr ".ra" 0.69999998807907104;
	setAttr ".dm" 2;
	setAttr ".fq" 10.687023162841797;
	setAttr ".fr" 2.5114502906799316;
	setAttr ".d" 0.20000000298023224;
	setAttr ".sr" 0.64999997615814209;
	setAttr ".rn" 0.5;
createNode cloud -n "cloud_for_bump";
	setAttr ".ail" yes;
	setAttr ".cg" -type "float3" 0.80000001 0.80000001 0.80000001 ;
	setAttr ".c1" -type "float3" 0.15790036 0.15790036 0.15790036 ;
	setAttr ".se" no;
	setAttr ".et" 1.0225564241409302;
	setAttr ".r" -type "float3" 1 1 2 ;
	setAttr ".a" 1.0687023401260376;
createNode PxrVoronoise -n "PxrVoronoise7";
	setAttr ".gain" 1.4164943695068359;
	setAttr ".lacunarity" 4.5842695236206055;
	setAttr ".jitter" 0.85393255949020386;
	setAttr ".smoothness" 0;
createNode PxrLMLayer -n "PxrLMLayer8";
	setAttr ".diffuseBehavior" no;
	setAttr ".specularRoughness" 0.42157304286956787;
	setAttr ".clearcoatColor" -type "float3" 0.61797512 0.61797512 0.61797512 ;
	setAttr ".clearcoatEta" 1.3250000476837158;
	setAttr ".clearcoatRoughness" 0.11999999731779099;
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -av -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "PxrBlend8.resultRGB" "PxrLMDiffuseMudDry.frontColor";
connectAttr "PxrBump11.resultN" "PxrLMDiffuseMudDry.bumpNormal";
connectAttr "PxrLMLayer8.result" "PxrLMDiffuseMudDry.lmlayer";
...
connectAttr "PxrVoronoise7.resultF" "PxrBlend9.bottomRGBr";
connectAttr "PxrVoronoise7.resultF" "PxrBlend9.bottomRGBg";
connectAttr "PxrVoronoise7.resultF" "PxrBlend9.bottomRGBb";
...
connectAttr "PxrBump11.resultN" "PxrLMLayer8.clearcoatNn";
connectAttr "PxrLMDiffuseMudDry.msg" ":defaultShaderList1.s" -na;
