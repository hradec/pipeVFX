...
//Name: leatherProcedural.ma
//Last modified: Sun, Feb 15, 2015 04:48:23 AM
//Codeset: 1252
requires maya "2014";
...
createNode place3dTexture -n "place3dTexture24";
createNode place3dTexture -n "place3dTexture25";
createNode PxrLMPlastic -n "PxrLMPlasticLeather";
	setAttr ".diffuseRoughness" 0.49438202381134033;
	setAttr ".sheen" -type "float3" 1 0.6398319 0.48299998 ;
	setAttr ".specularRoughness" 0.16853933036327362;
...
createNode PxrGamma -n "PxrGamma5";
	setAttr ".gamma" 0.0099999997764825821;
createNode leather -n "leather4";
	setAttr ".i" yes;
	setAttr ".ail" yes;
	setAttr ".ce" -type "float3" 1 1 1 ;
	setAttr ".cr" -type "float3" 0 0 0 ;
	setAttr ".cs" 0.20000000298023224;
	setAttr ".s" 0.18333333730697632;
	setAttr ".r" 0.76666665077209473;
	setAttr ".th" 0.95833331346511841;
createNode solidFractal -n "solidFractal2";
	setAttr ".cg" -type "float3" 0.52200001 0.27687556 0.17017199 ;
	setAttr ".co" -type "float3" 0.045807585 0.045807585 0.045807585 ;
	setAttr ".a" 0.92366409301757813;
	setAttr ".ra" 0.81679391860961914;
	setAttr ".th" 0.038167938590049744;
	setAttr ".fr" 2.3053436279296875;
createNode leather -n "leather3";
	setAttr ".ag" 0.55000001192092896;
	setAttr ".ce" -type "float3" 0.73000002 0.6243909 0.40588 ;
	setAttr ".cr" -type "float3" 0.34999618 0.21177997 0.1515526 ;
	setAttr ".cs" 0.15000000596046448;
	setAttr ".d" 0.85000002384185791;
	setAttr ".s" 0.060150377452373505;
	setAttr ".r" 0.36090224981307983;
	setAttr ".th" 0.83333331346511841;
	setAttr ".c" no;
...
createNode PxrGamma -n "PxrGamma6";
	setAttr ".gamma" 0.98876404762268066;
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
	setAttr -av -k on ".nds";
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -av -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "PxrBlend7.resultRGB" "PxrLMPlasticLeather.diffuseColor";
connectAttr "PxrBump6.resultN" "PxrLMPlasticLeather.diffuseNn";
connectAttr "PxrBump6.resultN" "PxrLMPlasticLeather.specularNn";
connectAttr "PxrGamma6.resultRGB" "PxrLMPlasticLeather.specularColor";
connectAttr ":defaultRenderGlobals.msg" "mtorPartition.rgcnx";
connectAttr "PxrGamma5.resultR" "PxrBlend7.topA";
connectAttr "solidFractal2.oc" "PxrBlend7.bottomRGB";
connectAttr "leather3.oc" "PxrBlend7.topRGB";
connectAttr "leather4.oc" "PxrGamma5.inputRGB";
connectAttr "place3dTexture24.wim" "leather4.pm";
connectAttr "place3dTexture25.wim" "solidFractal2.pm";
connectAttr "place3dTexture9.wim" "leather3.pm";
connectAttr "PxrToFloat6.resultF" "PxrBump6.inputBump";
connectAttr "PxrInvert3.resultRGB" "PxrToFloat6.input";
connectAttr "leather4.oc" "PxrInvert3.inputRGB";
connectAttr "PxrInvert3.resultRGB" "PxrGamma6.inputRGB";
connectAttr "PxrLMPlasticLeather.msg" ":defaultShaderList1.s" -na;
connectAttr "leather3.msg" ":defaultTextureList1.tx" -na;
connectAttr "leather4.msg" ":defaultTextureList1.tx" -na;
connectAttr "PxrBlend7.msg" ":defaultTextureList1.tx" -na;
connectAttr "PxrGamma5.msg" ":defaultTextureList1.tx" -na;
...
connectAttr "PxrGamma6.msg" ":defaultTextureList1.tx" -na;
connectAttr "place3dTexture9.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "place3dTexture24.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "place3dTexture25.msg" ":defaultRenderUtilityList1.u" -na;
// End of leatherProcedural.ma
