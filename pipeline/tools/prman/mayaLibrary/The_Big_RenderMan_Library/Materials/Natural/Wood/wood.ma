...
//Name: wood.ma
//Last modified: Fri, Feb 20, 2015 03:12:16 AM
//Codeset: 1252
requires maya "2014";
...
createNode place3dTexture -n "place3dTexture42";
	setAttr ".r" -type "double3" 0 90 0 ;
createNode PxrLMPlastic -n "PxrLMPlasticWood1";
...
createNode PxrBump -n "PxrBump9";
	setAttr ".scale" 0.0020000000949949026;
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
	setAttr -av -k on ".nds";
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -av -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "wood2.oc" "PxrLMPlasticWood1.diffuseColor";
connectAttr "blendColors10.opr" "PxrLMPlasticWood1.specularRoughness";
connectAttr "blendColors10.op" "PxrLMPlasticWood1.specularColor";
connectAttr "PxrVoronoise3.resultF" "PxrLMPlasticWood1.specularColorr";
connectAttr "PxrVoronoise3.resultF" "PxrLMPlasticWood1.specularColorg";
connectAttr "PxrVoronoise3.resultF" "PxrLMPlasticWood1.specularColorb";
connectAttr "PxrBump9.resultN" "PxrLMPlasticWood1.specularNn";
connectAttr "PxrBump9.resultN" "PxrLMPlasticWood1.diffuseNn";
connectAttr ":defaultRenderGlobals.msg" "mtorPartition.rgcnx";
connectAttr "place3dTexture42.wim" "wood2.pm";
connectAttr "PxrRemap10.resultRGB" "blendColors10.c1";
connectAttr "wood2.oa" "blendColors10.c2r";
connectAttr "wood2.oa" "blendColors10.c2g";
connectAttr "wood2.oa" "blendColors10.c2b";
connectAttr "PxrVoronoise3.resultF" "PxrRemap10.inputRGBr";
connectAttr "PxrVoronoise3.resultF" "PxrRemap10.inputRGBg";
connectAttr "PxrVoronoise3.resultF" "PxrRemap10.inputRGBb";
connectAttr "wood2.oa" "PxrBump9.inputBump";
connectAttr "PxrLMPlasticWood1.msg" ":defaultShaderList1.s" -na;
connectAttr "PxrRemap10.msg" ":defaultTextureList1.tx" -na;
connectAttr "PxrBump9.msg" ":defaultTextureList1.tx" -na;
connectAttr "wood2.msg" ":defaultTextureList1.tx" -na;
connectAttr "PxrVoronoise3.msg" ":defaultTextureList1.tx" -na;
connectAttr "place3dTexture42.msg" ":defaultRenderUtilityList1.u" -na;
