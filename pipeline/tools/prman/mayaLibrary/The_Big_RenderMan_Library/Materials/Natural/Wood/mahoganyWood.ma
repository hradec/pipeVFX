...
//Name: mahagonyWood.ma
//Last modified: Sat, Mar 14, 2015 04:43:56 AM
//Codeset: 1252
requires maya "2014";
...
createNode place3dTexture -n "place3dTexture2";
	setAttr ".t" -type "double3" -0.044 1.1711098295927516 -0.4 ;
	setAttr ".s" -type "double3" 1.2812893390655526 1.1706593888520731 1.2812886834144597 ;
createNode place3dTexture -n "place3dTexture3";
	...
	setAttr ".s" -type "double3" 1.2812893390655526 1.1706593888520731 1.2812886834144597 ;
createNode PxrLMPlastic -n "PxrWoodMahagony";
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -av -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "PxrBlend1.resultRGB" "PxrWoodMahagony.diffuseColor";
connectAttr "PxrToFloat1.resultF" "PxrWoodMahagony.specularRoughness";
connectAttr "PxrBump1.resultN" "PxrWoodMahagony.diffuseNn";
connectAttr "PxrBump1.resultN" "PxrWoodMahagony.specularNn";
connectAttr "PxrBump1.resultN" "PxrWoodMahagony.clearcoatNn";
connectAttr ":defaultRenderGlobals.msg" "mtorPartition.rgcnx";
connectAttr "solidFractal1.oa" "PxrBlend1.topA";
connectAttr "wood2.oc" "PxrBlend1.topRGB";
connectAttr "place3dTexture3.wim" "solidFractal1.pm";
connectAttr "place3dTexture2.wim" "wood2.pm";
connectAttr "stucco1.oc" "wood2.vc";
connectAttr "place3dTexture2.wim" "stucco1.pm";
connectAttr "PxrRemap1.resultRGB" "PxrToFloat1.input";
connectAttr "PxrVoronoise1.resultF" "PxrRemap1.inputRGBr";
connectAttr "PxrVoronoise1.resultF" "PxrRemap1.inputRGBg";
connectAttr "PxrVoronoise1.resultF" "PxrRemap1.inputRGBb";
connectAttr "PxrToFloat2.resultF" "PxrBump1.inputBump";
connectAttr "wood3.oc" "PxrToFloat2.input";
connectAttr "place3dTexture2.wim" "wood3.pm";
connectAttr "stucco2.oc" "wood3.vc";
connectAttr "place3dTexture2.wim" "stucco2.pm";
connectAttr "PxrWoodMahagony.msg" ":defaultShaderList1.s" -na;
