...
//Name: snow.ma
//Last modified: Mon, Mar 16, 2015 05:19:01 AM
//Codeset: 1252
requires maya "2014";
...
createNode place3dTexture -n "place3dTexture1";
	setAttr ".t" -type "double3" -0.04365074634552002 1.1711098295927516 -0.15133148431777954 ;
	setAttr ".s" -type "double3" 0.8 0.8 0.8 ;
createNode shadingEngine -n "PxrLMSubsurfaceSnowSG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
...
createNode PxrLMSubsurface -n "PxrLMSubsurface3";
	setAttr ".nearWeight" 1;
	setAttr ".midColor" -type "float3" 0.40000001 0.89999998 0.80000001 ;
	setAttr ".midWeight" 1;
	setAttr ".midLength" 1.2359549999237061;
	setAttr ".farColor" -type "float3" 0.23999999 0.63999999 0.91000003 ;
	setAttr ".farWeight" 1;
	setAttr ".farLength" 2.6966292858123779;
	setAttr ".specularColor" -type "float3" 1 1 1 ;
	setAttr ".specularRoughness" 0.15730337798595428;
createNode PxrFlakes -n "PxrFlakes1";
	setAttr ".flakeAmount" 0.58426964282989502;
	setAttr ".flakeFreq" 75.280899047851562;
	setAttr ".size" 0.5;
	setAttr ".octaves" 5;
	setAttr ".jitter" 0.92134833335876465;
createNode RMSDisplacement -n "RMSDisplacement2";
	setAttr ".sphere" 0.10000000149011612;
	setAttr ".displacementAmount" 0.039999999105930328;
createNode solidFractal -n "solidFractal1";
	setAttr ".ail" yes;
	setAttr ".ra" 0.79389315843582153;
	setAttr ".th" 0.0076335873454809189;
	setAttr ".r" -type "float3" 1 2 2 ;
	setAttr ".fr" 2.7175571918487549;
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -av -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "PxrLMSubsurface3.oc" "PxrLMSubsurfaceSnowSG.ss";
connectAttr "swatch_teapotShape.iog" "PxrLMSubsurfaceSnowSG.dsm" -na;
connectAttr "RMSDisplacement2.oc" "PxrLMSubsurfaceSnowSG.ds";
connectAttr ":defaultRenderGlobals.msg" "mtorPartition.rgcnx";
connectAttr "PxrLMSubsurfaceSnowSG.msg" "materialInfo76.sg";
connectAttr "PxrLMSubsurface3.msg" "materialInfo76.m";
connectAttr "PxrLMSubsurface3.msg" "materialInfo76.t" -na;
connectAttr "PxrFlakes1.resultN" "PxrLMSubsurface3.bumpNormal";
connectAttr "PxrFlakes1.resultN" "PxrLMSubsurface3.specularNn";
connectAttr "solidFractal1.oa" "RMSDisplacement2.displacementScalar";
connectAttr "place3dTexture1.wim" "solidFractal1.pm";
relationship "link" ":lightLinker1" ":initialShadingGroup.message" ":defaultLightSet.message";
relationship "link" ":lightLinker1" ":initialParticleSE.message" ":defaultLightSet.message";
relationship "link" ":lightLinker1" "PxrLMSubsurfaceSnowSG.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" ":initialShadingGroup.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" ":initialParticleSE.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" "PxrLMSubsurfaceSnowSG.message" ":defaultLightSet.message";
connectAttr "PxrLMSubsurfaceSnowSG.pa" ":renderPartition.st" -na;
connectAttr "PxrLMSubsurface3.msg" ":defaultShaderList1.s" -na;
connectAttr "RMSDisplacement2.msg" ":defaultShaderList1.s" -na;
