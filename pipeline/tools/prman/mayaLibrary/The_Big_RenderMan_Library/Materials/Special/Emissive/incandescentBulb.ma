...
//Name: bulb.ma
//Last modified: Mon, Mar 16, 2015 04:00:51 AM
//Codeset: 1252
requires maya "2014";
...
createNode transform -n "RMSMeshLight4";
createNode RMSMeshLight -n "RMSMeshLightShape2" -p "RMSMeshLight4";
	setAttr -k off ".v";
createNode shadingEngine -n "PxrLMGlassBulbSG";
...
createNode PxrLMGlass -n "PxrLMGlassBulb";
	setAttr ".thin" yes;
	setAttr ".absorption" 0.20000000298023224;
	setAttr ".shadows" 1;
createNode PxrBlackBody -n "PxrBlackBody1";
	setAttr ".temperature" 3000;
	setAttr ".physicalIntensity" 1;
createNode PxrRemap -n "PxrRemap3";
	setAttr ".bias" -type "float3" 0.49437705 0.49437705 0.49437705 ;
	setAttr ".gain" -type "float3" 0.49437705 0.49437705 0.49437705 ;
	setAttr ".outputMin" 0.40000000596046448;
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -av -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "PxrBlackBody1.resultRGB" "RMSMeshLightShape2.lightcolor";
connectAttr "PxrBlackBody1.temperature" "RMSMeshLightShape2.temperature";
connectAttr "PxrLMGlassBulb.oc" "PxrLMGlassBulbSG.ss";
connectAttr "swatch_teapotShape.iog" "PxrLMGlassBulbSG.dsm" -na;
connectAttr "RMSMeshLightShape2.msg" "PxrLMGlassBulbSG.rman__torattr___areaLightShader"
		;
connectAttr ":defaultRenderGlobals.msg" "mtorPartition.rgcnx";
connectAttr "PxrLMGlassBulbSG.msg" "materialInfo75.sg";
connectAttr "PxrLMGlassBulb.msg" "materialInfo75.m";
connectAttr "PxrLMGlassBulb.msg" "materialInfo75.t" -na;
connectAttr "PxrBlackBody1.resultRGB" "PxrLMGlassBulb.transmissionColor";
connectAttr "PxrRemap3.resultRGB" "PxrLMGlassBulb.refractionColor";
connectAttr "PxrFacingRatio1.resultF" "PxrRemap3.inputRGBr";
connectAttr "PxrFacingRatio1.resultF" "PxrRemap3.inputRGBg";
connectAttr "PxrFacingRatio1.resultF" "PxrRemap3.inputRGBb";
relationship "link" ":lightLinker1" ":initialShadingGroup.message" ":defaultLightSet.message";
relationship "link" ":lightLinker1" ":initialParticleSE.message" ":defaultLightSet.message";
relationship "link" ":lightLinker1" "PxrLMGlassBulbSG.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" ":initialShadingGroup.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" ":initialParticleSE.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" "PxrLMGlassBulbSG.message" ":defaultLightSet.message";
connectAttr "PxrLMGlassBulbSG.pa" ":renderPartition.st" -na;
connectAttr "PxrLMGlassBulb.msg" ":defaultShaderList1.s" -na;
...
connectAttr "RMSMeshLightShape2.ltd" ":lightList1.l" -na;
connectAttr "RMSMeshLight4.iog" ":defaultLightSet.dsm" -na;
// End of bulb.ma
