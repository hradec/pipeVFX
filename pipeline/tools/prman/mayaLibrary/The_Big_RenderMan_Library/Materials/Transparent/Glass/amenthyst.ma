...
//Name: amenthyst.ma
//Last modified: Tue, Mar 24, 2015 11:50:21 AM
//Codeset: 1252
requires maya "2014";
...
createNode PxrLMGlass -n "PxrLMGlassAmenthyst";
	setAttr ".eta" 1.5399999618530273;
	setAttr ".refractionColor" -type "float3" 0.96350002 0.92699999 1 ;
	setAttr ".absorption" 10;
	setAttr ".transmissionColor" -type "float3" 0.66000003 0.40000001 0.80000001 ;
	setAttr ".shadows" 1;
...
createNode PxrVoronoise -n "PxrVoronoise3";
	setAttr ".frequency" 3.6292135715484619;
	setAttr ".gain" 1.1015729904174805;
	setAttr ".lacunarity" 1.7999999523162842;
	setAttr ".jitter" 1;
	setAttr ".smoothness" 0.10000000149011612;
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -av -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "PxrLMGlassAmenthyst.oc" "PxrLMGlass2SG.ss";
connectAttr "swatch_teapotShape.iog" "PxrLMGlass2SG.dsm" -na;
connectAttr "RMSDisplacement2.oc" "PxrLMGlass2SG.ds";
connectAttr ":defaultRenderGlobals.msg" "mtorPartition.rgcnx";
connectAttr "PxrLMGlass2SG.msg" "materialInfo72.sg";
connectAttr "PxrLMGlassAmenthyst.msg" "materialInfo72.m";
connectAttr "PxrLMGlassAmenthyst.msg" "materialInfo72.t" -na;
connectAttr "PxrBump6.resultN" "PxrLMGlassAmenthyst.bumpNormal";
connectAttr "cloud1.oa" "PxrBump6.inputBump";
connectAttr "place3dTexture10.wim" "cloud1.pm";
connectAttr "PxrRemap7.resultR" "RMSDisplacement2.displacementScalar";
connectAttr "PxrVoronoise3.resultF" "PxrRemap7.inputRGBr";
connectAttr "PxrVoronoise3.resultF" "PxrRemap7.inputRGBb";
connectAttr "PxrVoronoise3.resultF" "PxrRemap7.inputRGBg";
...
connectAttr "PxrLMGlassAmenthyst.msg" ":defaultShaderList1.s" -na;
