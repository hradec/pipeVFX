...
//Name: iceFrosted.ma
//Last modified: Mon, Mar 16, 2015 07:36:30 AM
//Codeset: 1252
requires maya "2014";
...
createNode place3dTexture -n "iceFrosted:place3dTexture4";
createNode PxrLMGlass -n "iceFrosted:PxrLMGlassIce";
	setAttr ".eta" 1.3090000152587891;
	setAttr ".refractionColor" -type "float3" 1 1 1 ;
	setAttr ".roughness" 0.05000000074505806;
	setAttr ".transmissionColor" -type "float3" 0.98876935 0.98876935 0.98876935 ;
	setAttr ".shadows" 1;
...
createNode PxrBump -n "iceFrosted:PxrBump3";
	setAttr ".scale" 0.029999999329447746;
createNode cloud -n "iceFrosted:ice_cloud";
	setAttr ".ail" yes;
	setAttr ".c2" -type "float3" 0.64999998 0.64999998 0.64999998 ;
	setAttr ".c" 0.60000002384185791;
	setAttr ".se" no;
	setAttr ".r" -type "float3" 1 2 2 ;
	setAttr ".d" -type "float2" 0 10 ;
	setAttr ".a" 1.776960015296936;
createNode PxrLMLayer -n "iceFrosted:PxrLMLayer2";
	setAttr ".diffuseBehavior" no;
	setAttr ".clearcoatEta" 1.3250000476837158;
	setAttr ".clearcoatRoughness" 0.087865166366100311;
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -av -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "iceFrosted:PxrBump3.resultN" "iceFrosted:PxrLMGlassIce.bumpNormal";
connectAttr "iceFrosted:PxrLMLayer2.result" "iceFrosted:PxrLMGlassIce.lmlayer";
connectAttr ":defaultRenderGlobals.msg" "mtorPartition.rgcnx";
connectAttr "iceFrosted:ice_cloud.oa" "iceFrosted:PxrBump3.inputBump";
connectAttr "iceFrosted:place3dTexture4.wim" "iceFrosted:ice_cloud.pm";
connectAttr "iceFrosted:PxrBump3.resultN" "iceFrosted:PxrLMLayer2.specularNn";
connectAttr "iceFrosted:ice_cloud.oa" "iceFrosted:PxrLMLayer2.specularRoughness"
		;
connectAttr "iceFrosted:PxrLMGlassIce.msg" ":defaultShaderList1.s" -na;
connectAttr "iceFrosted:ice_cloud.msg" ":defaultTextureList1.tx" -na;
connectAttr "iceFrosted:PxrBump3.msg" ":defaultTextureList1.tx" -na;
connectAttr "iceFrosted:place3dTexture4.msg" ":defaultRenderUtilityList1.u" -na;
// End of iceFrosted.ma
