...
//Name: Metal_Alloy_Brass.ma
//Last modified: Sun, Feb 01, 2015 03:36:59 AM
//Codeset: 1252
requires maya "2014";
...
createNode PxrLMMetal -n "PxrLMMetalBrass";
	setAttr ".eta" -type "float3" 0.2 0.89899999 1.102 ;
	setAttr ".kappa" -type "float3" 2.122 2.5 1.535 ;
	setAttr ".roughness" 0.18000000715255737;
	setAttr ".anisotropy" -0.73033708333969116;
...
createNode PxrBlend -n "PxrBlend11";
	...
	setAttr ".bottomRGB" -type "float3" 0.213 0.20890747 0.111825 ;
createNode noise -n "noise5";
	setAttr ".i" yes;
	setAttr ".ail" yes;
	setAttr ".th" 0.39316239953041077;
	setAttr ".dm" 4;
	setAttr ".fq" 8.5470085144042969;
	setAttr ".d" 0.034188035875558853;
	setAttr ".sp" 1;
	setAttr ".sr" 1;
	setAttr ".fof" 0;
createNode place2dTexture -n "place2dTexture17";
	setAttr ".re" -type "float2" 1 4 ;
createNode fractal -n "fractal13";
	setAttr ".ail" yes;
	setAttr ".an" yes;
createNode place2dTexture -n "place2dTexture18";
	setAttr ".re" -type "float2" 0.2 0.2 ;
createNode fractal -n "fractal14";
	setAttr ".ail" yes;
	setAttr ".an" yes;
	setAttr ".ti" 18.796993255615234;
createNode PxrBlend -n "PxrBlend12";
	setAttr ".topRGB" -type "float3" 0.89300001 0.890374 0.827811 ;
	setAttr ".bottomRGB" -type "float3" 0.59600002 0.5942474 0.55249202 ;
createNode PxrBump -n "PxrBump5";
	setAttr ".scale" 0.0060000000521540642;
createNode noise -n "noise7";
	setAttr ".ail" yes;
	setAttr ".ag" 0.10000000149011612;
	setAttr ".ra" 0.6239316463470459;
	setAttr ".th" 0.39316239953041077;
	setAttr ".dm" 7;
	setAttr ".fq" 100;
	setAttr ".fr" 2.230769157409668;
	setAttr ".sp" 1;
	setAttr ".sr" 0.20512820780277252;
	setAttr ".fof" 0;
createNode place2dTexture -n "place2dTexture19";
	setAttr ".rf" 219.24811993678509;
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
	setAttr -av -k on ".nds";
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -av -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "PxrLMLayer2.result" "PxrLMMetalBrass.lmlayer";
connectAttr "PxrBlend12.resultRGB" "PxrLMMetalBrass.specularColor";
connectAttr "PxrBump5.resultN" "PxrLMMetalBrass.bumpNormal";
connectAttr ":defaultRenderGlobals.msg" "mtorPartition.rgcnx";
connectAttr "PxrBlend11.resultRGB" "PxrLMLayer2.diffuseColor";
connectAttr "noise5.oc" "PxrBlend11.topRGB";
connectAttr "place2dTexture17.o" "noise5.uv";
connectAttr "place2dTexture17.ofs" "noise5.fs";
connectAttr "fractal13.oa" "place2dTexture17.tfu";
connectAttr "fractal14.oa" "place2dTexture17.tfv";
connectAttr "place2dTexture18.o" "fractal13.uv";
connectAttr "place2dTexture18.ofs" "fractal13.fs";
connectAttr "place2dTexture18.o" "fractal14.uv";
connectAttr "place2dTexture18.ofs" "fractal14.fs";
connectAttr "noise5.oa" "PxrBlend12.topA";
connectAttr "noise7.oa" "PxrBump5.inputBump";
connectAttr "place2dTexture19.o" "noise7.uv";
connectAttr "place2dTexture19.ofs" "noise7.fs";
connectAttr "fractal13.oa" "place2dTexture19.tfu";
connectAttr "fractal14.oa" "place2dTexture19.tfv";
connectAttr "PxrLMMetalBrass.msg" ":defaultShaderList1.s" -na;
connectAttr "noise5.msg" ":defaultTextureList1.tx" -na;
connectAttr "fractal13.msg" ":defaultTextureList1.tx" -na;
connectAttr "fractal14.msg" ":defaultTextureList1.tx" -na;
connectAttr "PxrBlend11.msg" ":defaultTextureList1.tx" -na;
connectAttr "PxrBlend12.msg" ":defaultTextureList1.tx" -na;
connectAttr "noise7.msg" ":defaultTextureList1.tx" -na;
connectAttr "PxrBump5.msg" ":defaultTextureList1.tx" -na;
connectAttr "place2dTexture17.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "place2dTexture18.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "place2dTexture19.msg" ":defaultRenderUtilityList1.u" -na;
// End of Metal_Alloy_Brass.ma
