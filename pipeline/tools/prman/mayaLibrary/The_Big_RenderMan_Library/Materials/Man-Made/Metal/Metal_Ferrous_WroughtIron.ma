...
//Name: Metal_Ferrous_WroughtIron.ma
//Last modified: Sun, Feb 01, 2015 03:38:30 AM
//Codeset: 1252
requires maya "2014";
...
createNode place3dTexture -n "place3dTexture15";
createNode place3dTexture -n "place3dTexture16";
createNode PxrLMMetal -n "wroughtIron1:PxrLMMetal3";
	setAttr ".eta" -type "float3" 2.6944551 2.723 2.309104 ;
createNode partition -n "mtorPartition";
	...
	setAttr ".sr" -type "string" (
		...
		+ "TransformEnd\nIfEnd\n}}\n");
createNode PxrBump -n "wroughtIron1:PxrBump4";
...
createNode PxrVoronoise -n "wroughtIron1:PxrVoronoise2";
	setAttr ".frequency" 50;
	setAttr ".octaves" 6;
	setAttr ".lacunarity" 3.0561797618865967;
	setAttr ".jitter" 1;
	setAttr ".smoothness" 0.44943821430206299;
createNode PxrManifold2D -n "PxrManifold2D3";
	setAttr ".scaleS" 5;
	setAttr ".scaleT" 5;
createNode crater -n "crater2";
	setAttr ".ail" yes;
	setAttr ".sh" 0.80000001192092896;
	setAttr ".c1" -type "float3" 1 1 1 ;
	setAttr ".c2" -type "float3" 0.1282063 0.1282063 0.1282063 ;
	setAttr ".c3" -type "float3" 0 0 0 ;
	setAttr ".fr" 1.8803418874740601;
createNode remapColor -n "remapColor1";
	setAttr ".omx" 1.9829059839248657;
	setAttr -s 2 ".r[0:1]"  0 0 1 1 1 1;
	setAttr -s 2 ".g[0:1]"  0 0 1 1 1 1;
	setAttr -s 2 ".b[0:1]"  0 0 1 1 1 1;
createNode PxrBlend -n "PxrBlend9";
	setAttr ".operation" 21;
	setAttr ".bottomRGB" -type "float3" 1 0.44303995 0.055999994 ;
createNode PxrToFloat -n "PxrToFloat7";
	setAttr ".mode" 4;
createNode PxrInvert -n "PxrInvert2";
createNode PxrRemap -n "PxrRemap8";
	setAttr ".bias" -type "float3" 0.89999998 0.89999998 0.89999998 ;
	setAttr ".gain" -type "float3" 0.55056077 0.55056077 0.55056077 ;
createNode PxrBlend -n "PxrBlend6";
createNode PxrRemap -n "PxrRemap6";
	setAttr ".bias" -type "float3" 0.24719615 0.24719615 0.24719615 ;
	setAttr ".gain" -type "float3" 0.68538946 0.68538946 0.68538946 ;
createNode noise -n "noise4";
	setAttr ".ra" 1;
	setAttr ".th" 0.74358975887298584;
	setAttr ".fq" 7.6923079490661621;
	setAttr ".nty" 2;
	setAttr ".nw" 3;
createNode place2dTexture -n "place2dTexture16";
	setAttr ".rf" 16.240601588557606;
	setAttr ".re" -type "float2" 5 0.5 ;
	setAttr ".n" -type "float2" 0 0.0020000001 ;
createNode solidFractal -n "solidFractal4";
	setAttr ".ra" 0.82706767320632935;
	setAttr ".th" 0.36090224981307983;
	setAttr ".fr" 2.2180449962615967;
	setAttr ".in" yes;
createNode PxrRemap -n "PxrRemap7";
createNode cloud -n "cloud3";
	setAttr ".c" 0.72932332754135132;
	setAttr ".ct" 0.23308271169662476;
	setAttr ".et" 0.70676690340042114;
	setAttr ".r" -type "float3" 2 2 2 ;
	setAttr ".a" 1.8796992301940918;
	setAttr ".ra" 0.73684209585189819;
createNode cloud -n "cloud4";
	setAttr ".c1" -type "float3" 1 0.37078333 0 ;
	setAttr ".c2" -type "float3" 1 0.33700001 0.33700001 ;
	setAttr ".c" 1;
	setAttr ".ct" 0.099236644804477692;
	setAttr ".et" 1.1297709941864014;
	setAttr ".a" 1.6030534505844116;
	setAttr ".ra" 0.8320610523223877;
createNode PxrToFloat -n "PxrToFloat8";
createNode PxrBlend -n "PxrBlend7";
	setAttr ".topRGB" -type "float3" 0.58200002 0.58200002 0.58200002 ;
	setAttr ".bottomRGB" -type "float3" 0.079000004 0.079000004 0.079000004 ;
createNode PxrBlend -n "PxrBlend8";
	setAttr ".topRGB" -type "float3" 0.69599998 0.69599998 0.69599998 ;
	setAttr ".bottomRGB" -type "float3" 0.47499999 0.47499999 0.47499999 ;
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
	setAttr -av -k on ".nds";
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -av -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "wroughtIron1:PxrBump4.resultN" "wroughtIron1:PxrLMMetal3.bumpNormal"
		;
connectAttr "remapColor1.oc" "wroughtIron1:PxrLMMetal3.kappa";
connectAttr "PxrToFloat8.resultF" "wroughtIron1:PxrLMMetal3.roughness";
connectAttr "PxrBlend8.resultRGB" "wroughtIron1:PxrLMMetal3.specularColor";
connectAttr ":defaultRenderGlobals.msg" "mtorPartition.rgcnx";
connectAttr "PxrToFloat6.resultF" "wroughtIron1:PxrBump4.inputBump";
connectAttr "PxrBlend5.resultRGB" "PxrToFloat6.input";
connectAttr "PxrInvert1.resultRGB" "PxrBlend5.topRGB";
connectAttr "crater2.oa" "PxrBlend5.topA";
connectAttr "wroughtIron1:PxrVoronoise2.resultF" "PxrInvert1.inputRGBr";
connectAttr "wroughtIron1:PxrVoronoise2.resultF" "PxrInvert1.inputRGBg";
connectAttr "wroughtIron1:PxrVoronoise2.resultF" "PxrInvert1.inputRGBb";
connectAttr "PxrManifold2D3.result" "wroughtIron1:PxrVoronoise2.manifold";
connectAttr "place3dTexture12.wim" "crater2.pm";
connectAttr "PxrBlend9.resultRGB" "remapColor1.cl";
connectAttr "PxrToFloat7.resultF" "PxrBlend9.topA";
connectAttr "cloud4.oc" "PxrBlend9.topRGB";
connectAttr "PxrInvert2.resultRGB" "PxrToFloat7.input";
connectAttr "PxrRemap8.resultRGB" "PxrInvert2.inputRGB";
connectAttr "PxrBlend6.resultRGB" "PxrRemap8.inputRGB";
connectAttr "PxrRemap6.resultRGB" "PxrBlend6.topRGB";
connectAttr "solidFractal4.oa" "PxrBlend6.topA";
connectAttr "PxrRemap7.resultRGB" "PxrBlend6.bottomRGB";
connectAttr "noise4.oc" "PxrRemap6.inputRGB";
connectAttr "place2dTexture16.o" "noise4.uv";
connectAttr "place2dTexture16.ofs" "noise4.fs";
connectAttr "place3dTexture14.wim" "solidFractal4.pm";
connectAttr "cloud3.oc" "PxrRemap7.inputRGB";
connectAttr "place3dTexture15.wim" "cloud3.pm";
connectAttr "place3dTexture16.wim" "cloud4.pm";
connectAttr "PxrBlend7.resultRGB" "PxrToFloat8.input";
connectAttr "PxrToFloat7.resultF" "PxrBlend7.topA";
connectAttr "PxrToFloat7.resultF" "PxrBlend8.topA";
connectAttr "wroughtIron1:PxrLMMetal3.msg" ":defaultShaderList1.s" -na;
connectAttr "wroughtIron1:PxrBump4.msg" ":defaultTextureList1.tx" -na;
connectAttr "wroughtIron1:PxrVoronoise2.msg" ":defaultTextureList1.tx" -na;
...
connectAttr "solidFractal4.msg" ":defaultTextureList1.tx" -na;
...
connectAttr "PxrToFloat8.msg" ":defaultTextureList1.tx" -na;
...
connectAttr "place3dTexture15.msg" ":defaultRenderUtilityList1.u" -na;
...
// End of Metal_Ferrous_WroughtIron.ma
