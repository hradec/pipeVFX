...
//Name: Metal_Ferrous_SteelSwirl.ma
//Last modified: Sun, Feb 01, 2015 03:11:57 AM
//Codeset: 1252
requires maya "2014";
...
createNode PxrLMMetal -n "PxrLMMetalSteelSwirl";
	setAttr ".roughness" 0.60000002384185791;
	setAttr ".anisotropy" -0.89999997615814209;
...
createNode PxrTexture -n "PxrTexture1";
	setAttr ".filename" -type "string" "D:/pixar_Freelance/texture/aniso_vec_circles.tex";
createNode PxrManifold2D -n "PxrManifold2D2";
	setAttr ".scaleS" 30;
	setAttr ".scaleT" 30;
createNode PxrFractal -n "PxrFractal2";
	setAttr ".frequency" 2.3247191905975342;
	setAttr ".lacunarity" 3.2584269046783447;
	setAttr ".dimension" 1.5280898809432983;
	setAttr ".erosion" 0.96629214286804199;
	setAttr ".variation" 0.39325842261314392;
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
	setAttr -av -k on ".nds";
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -av -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "PxrTangentField1.resultXYZ" "PxrLMMetalSteelSwirl.shadingTangent";
connectAttr "PxrFractal2.resultF" "PxrLMMetalSteelSwirl.specularColorr";
connectAttr "PxrFractal2.resultF" "PxrLMMetalSteelSwirl.specularColorg";
connectAttr "PxrFractal2.resultF" "PxrLMMetalSteelSwirl.specularColorb";
connectAttr ":defaultRenderGlobals.msg" "mtorPartition.rgcnx";
connectAttr "PxrTexture1.resultRGB" "PxrTangentField1.inputVector";
connectAttr "PxrManifold2D2.result" "PxrTexture1.manifold";
connectAttr "PxrLMMetalSteelSwirl.msg" ":defaultShaderList1.s" -na;
...
// End of Metal_Ferrous_SteelSwirl.ma
