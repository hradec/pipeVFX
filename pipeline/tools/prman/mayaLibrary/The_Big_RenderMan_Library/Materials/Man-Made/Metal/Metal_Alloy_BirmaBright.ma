...
//Name: Metal_Alloy_BirmaBright.ma
//Last modified: Sun, Feb 01, 2015 03:34:19 AM
//Codeset: 1252
requires maya "2014";
...
createNode solidFractal -n "solidFractal2";
	setAttr ".ail" yes;
	setAttr ".ag" 4;
	setAttr ".r" -type "float3" 2 2 6 ;
createNode solidFractal -n "solidFractal1";
	setAttr ".ail" yes;
	setAttr ".ag" 0.5;
	setAttr ".ao" 0.10000000149011612;
	setAttr ".r" -type "float3" 2 2 6 ;
...
createNode brownian -n "brownian1";
	setAttr ".ail" yes;
	setAttr ".cg" -type "float3" 0.11436637 0.11436637 0.11436637 ;
	setAttr ".ag" 0.5;
	setAttr ".ao" -0.20000000298023224;
	setAttr ".l" 2.7008798122406006;
	setAttr ".ic" 0;
	setAttr ".oct" 4;
	setAttr ".w3" -type "float3" 2 50 6 ;
createNode cloud -n "cloud2";
	setAttr ".c2" -type "float3" 0 0 0 ;
	setAttr ".c" 2.168670654296875;
	setAttr ".tr" 0.49853372573852539;
	setAttr ".ct" 1;
	setAttr ".et" 1.8030768632888794;
	setAttr ".r" -type "float3" 2 2 2 ;
	setAttr ".a" 2.2000000476837158;
	setAttr ".ra" 0.80000001192092896;
createNode noise -n "noise1";
	setAttr ".i" yes;
	setAttr ".ail" yes;
	setAttr ".a" 0.95692306756973267;
	setAttr ".ra" 1;
	setAttr ".th" 1;
	setAttr ".dm" 2;
	setAttr ".fq" 33.230770111083984;
	setAttr ".fr" 1.6646153926849365;
	setAttr ".nty" 0;
createNode place2dTexture -n "place2dTexture6";
	setAttr ".re" -type "float2" 1 5 ;
	setAttr ".r" 145.68914952932678;
	setAttr ".n" -type "float2" 0.02 0.0099999998 ;
	setAttr ".fa" yes;
createNode PxrToFloat -n "PxrToFloat3";
	setAttr ".mode" 3;
createNode PxrRemap -n "PxrRemap2";
createNode fractal -n "fractal5";
	setAttr ".ra" 0.40469208359718323;
	setAttr ".lmx" 10.630498886108398;
	setAttr ".fr" 1.4222873449325562;
	setAttr ".in" yes;
...
createNode fractal -n "fractal4";
	setAttr ".ra" 0;
	setAttr ".lmx" 7.8445749282836914;
	setAttr ".fr" 2.0557184219360352;
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -av -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "solidFractal2.oa" "PxrLMMetalBirmaBright.anisotropy";
connectAttr "solidFractal1.oa" "PxrLMMetalBirmaBright.roughness";
connectAttr "PxrBump1.resultN" "PxrLMMetalBirmaBright.bumpNormal";
connectAttr ":defaultRenderGlobals.msg" "mtorPartition.rgcnx";
connectAttr "place3dTexture2.wim" "solidFractal2.pm";
connectAttr "place3dTexture2.wim" "solidFractal1.pm";
connectAttr "PxrToFloat1.resultF" "PxrBump1.inputBump";
connectAttr "PxrBlend1.resultRGB" "PxrToFloat1.input";
connectAttr "brownian1.oc" "PxrBlend1.bottomRGB";
connectAttr "cloud2.oa" "PxrBlend1.topA";
connectAttr "noise1.oc" "PxrBlend1.topRGB";
connectAttr "place3dTexture5.wim" "brownian1.pm";
connectAttr "place3dTexture4.wim" "cloud2.pm";
connectAttr "place2dTexture6.o" "noise1.uv";
connectAttr "place2dTexture6.ofs" "noise1.fs";
connectAttr "PxrToFloat3.resultF" "place2dTexture6.v";
connectAttr "PxrToFloat2.resultF" "place2dTexture6.u";
connectAttr "PxrRemap2.resultRGB" "PxrToFloat3.input";
connectAttr "fractal5.oc" "PxrRemap2.inputRGB";
connectAttr "place2dTexture8.o" "fractal5.uv";
connectAttr "place2dTexture8.ofs" "fractal5.fs";
connectAttr "PxrRemap1.resultRGB" "PxrToFloat2.input";
connectAttr "fractal4.oc" "PxrRemap1.inputRGB";
connectAttr "place2dTexture7.o" "fractal4.uv";
connectAttr "place2dTexture7.ofs" "fractal4.fs";
connectAttr "PxrLMMetalBirmaBright.msg" ":defaultShaderList1.s" -na;
...
// End of Metal_Alloy_BirmaBright.ma
