...
//Name: Metal_NonFerrous_Gold.ma
//Last modified: Sun, Feb 01, 2015 03:35:49 AM
//Codeset: 1252
requires maya "2014";
...
createNode PxrLMMetal -n "PxrLMMetalGold";
	setAttr ".eta" -type "float3" 0.14285696 0.37480223 1.443 ;
	setAttr ".kappa" -type "float3" 3.983 2.3843131 1.601166 ;
	setAttr ".roughness" 0.12359550595283508;
	setAttr ".specularColor" -type "float3" 1 0.87206668 0.59599996 ;
...
createNode PxrFractal -n "PxrFractal3";
	setAttr ".frequency" 9.3325843811035156;
	setAttr ".lacunarity" 2.702247142791748;
createNode PxrManifold2D -n "PxrManifold2D7";
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
	setAttr -av -k on ".nds";
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -av -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "PxrBump3.resultN" "PxrLMMetalGold.bumpNormal";
connectAttr ":defaultRenderGlobals.msg" "mtorPartition.rgcnx";
connectAttr "PxrFractal3.resultF" "PxrBump3.inputBump";
connectAttr "PxrManifold2D7.result" "PxrFractal3.manifold";
connectAttr "PxrLMMetalGold.msg" ":defaultShaderList1.s" -na;
connectAttr "PxrBump3.msg" ":defaultTextureList1.tx" -na;
connectAttr "PxrFractal3.msg" ":defaultTextureList1.tx" -na;
// End of Metal_NonFerrous_Gold.ma
