...
//Name: layered_ply.ma
//Last modified: Sun, Feb 15, 2015 08:28:29 PM
//Codeset: 1252
requires maya "2014";
...
createNode PxrLMPlastic -n "PxrLMPlasticPly";
	setAttr ".diffuseRoughness" 0.29213482141494751;
	setAttr ".specularColor" -type "float3" 1 1 1 ;
	setAttr ".specularRoughness" 0.35955056548118591;
	setAttr ".clearcoatColor" -type "float3" 1 1 1 ;
	setAttr ".clearcoatRoughness" 0.22134831547737122;
...
createNode noise -n "noise6";
	setAttr ".ail" yes;
	setAttr ".ra" 0.90833336114883423;
	setAttr ".dm" 1;
	setAttr ".fq" 70;
	setAttr ".fr" 4;
	setAttr ".ti" 0.083333335816860199;
	setAttr ".d" 0.075000002980232239;
	setAttr ".sp" 1;
	setAttr ".sr" 1;
	setAttr ".fof" 1;
...
createNode fractal -n "fractal3";
	setAttr ".an" yes;
	setAttr ".ti" 18.045112609863281;
createNode place2dTexture -n "place2dTexture9";
createNode fractal -n "fractal4";
	setAttr ".an" yes;
createNode PxrBlend -n "PxrBlend3";
	setAttr ".topRGB" -type "float3" 0.89300001 0.80072993 0.67689401 ;
createNode noise -n "noise5";
	setAttr ".i" yes;
	setAttr ".ail" yes;
	setAttr ".ag" 0.10000000149011612;
	setAttr ".a" 0.78333336114883423;
	setAttr ".ra" 0.78333336114883423;
	setAttr ".fq" 100;
	setAttr ".fr" 2.7999999523162842;
	setAttr ".nty" 0;
createNode place2dTexture -n "place2dTexture11";
	setAttr ".re" -type "float2" 4 1 ;
createNode fractal -n "fractal5";
	setAttr ".ra" 0.52631580829620361;
	setAttr ".lmx" 3.9473683834075928;
	setAttr ".fr" 1.4060150384902954;
	setAttr ".an" yes;
...
createNode fractal -n "fractal6";
	...
	setAttr ".fr" 1.4060150384902954;
	setAttr ".an" yes;
	setAttr ".ti" 21.052631378173828;
createNode noise -n "noise4";
	setAttr ".ail" yes;
	setAttr ".cg" -type "float3" 1 0.82152998 0.63999999 ;
	setAttr ".co" -type "float3" 0.84799999 0.56154537 0.39092803 ;
	setAttr ".a" 0.3333333432674408;
	setAttr ".ra" 0.57499998807907104;
	setAttr ".th" 0.02500000037252903;
	setAttr ".fq" 2.5;
	setAttr ".nty" 0;
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -av -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "PxrBlend4.resultRGB" "PxrLMPlasticPly.diffuseColor";
connectAttr "PxrBump3.resultN" "PxrLMPlasticPly.specularNn";
connectAttr "PxrBump3.resultN" "PxrLMPlasticPly.diffuseNn";
connectAttr "PxrBump3.resultN" "PxrLMPlasticPly.clearcoatNn";
connectAttr ":defaultRenderGlobals.msg" "mtorPartition.rgcnx";
connectAttr "noise6.oa" "PxrBlend4.topA";
connectAttr "PxrBlend3.resultRGB" "PxrBlend4.bottomRGB";
connectAttr "brownian1.oc" "PxrBlend4.topRGB";
connectAttr "place2dTexture13.o" "noise6.uv";
connectAttr "place2dTexture13.ofs" "noise6.fs";
connectAttr "fractal3.oa" "place2dTexture13.tfu";
connectAttr "fractal4.oa" "place2dTexture13.tfv";
connectAttr "place2dTexture9.o" "fractal3.uv";
connectAttr "place2dTexture9.ofs" "fractal3.fs";
connectAttr "place2dTexture9.o" "fractal4.uv";
connectAttr "place2dTexture9.ofs" "fractal4.fs";
connectAttr "noise5.oa" "PxrBlend3.topA";
connectAttr "noise4.oc" "PxrBlend3.bottomRGB";
connectAttr "place2dTexture11.o" "noise5.uv";
connectAttr "place2dTexture11.ofs" "noise5.fs";
connectAttr "fractal5.oa" "place2dTexture11.tfu";
connectAttr "fractal6.oa" "place2dTexture11.tfv";
connectAttr "place2dTexture12.o" "fractal5.uv";
connectAttr "place2dTexture12.ofs" "fractal5.fs";
connectAttr "place2dTexture12.o" "fractal6.uv";
connectAttr "place2dTexture12.ofs" "fractal6.fs";
connectAttr "place2dTexture8.o" "noise4.uv";
connectAttr "place2dTexture8.ofs" "noise4.fs";
connectAttr "fractal3.oa" "place2dTexture8.u";
connectAttr "fractal4.oa" "place2dTexture8.v";
connectAttr "place3dTexture7.wim" "brownian1.pm";
connectAttr "noise5.oa" "PxrBump3.inputBump";
connectAttr "PxrLMPlasticPly.msg" ":defaultShaderList1.s" -na;
