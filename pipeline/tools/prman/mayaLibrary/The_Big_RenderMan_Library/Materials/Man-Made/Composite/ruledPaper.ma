...
//Name: ruledPaper.ma
//Last modified: Sat, Apr 04, 2015 08:50:18 PM
//Codeset: 1252
requires maya "2014";
...
createNode PxrLMPlastic -n "PxrLMPlasticPaperRuled";
	setAttr ".translucence" 0.47191011905670166;
	setAttr ".specularColor" -type "float3" 0.56179142 0.56179142 0.56179142 ;
	setAttr ".specularRoughness" 0.76404494047164917;
...
createNode PxrBump -n "PxrBump7";
	setAttr ".scale" 0.15600000321865082;
createNode PxrWorley -n "PxrWorley1";
	setAttr ".frequency" 0.62921351194381714;
	setAttr ".distancemetric" 2;
	setAttr ".jitter" 0.89887642860412598;
	setAttr ".minkowskiExponent" 2.033707857131958;
	setAttr ".invert" yes;
...
createNode stucco -n "stucco4";
	setAttr ".ail" yes;
	setAttr ".cg" -type "float3" 180 180 180 ;
	setAttr ".sh" 7.3684210777282715;
	setAttr ".c1" -type "float3" 2 2 2 ;
	setAttr ".c2" -type "float3" 0.71429008 0.71429008 0.71429008 ;
createNode ramp -n "ramp5";
	setAttr ".in" 0;
	setAttr -s 3 ".cel";
	setAttr ".cel[0].ep" 0;
	setAttr ".cel[0].ec" -type "float3" 0.93300003 0.93300003 0.93300003 ;
	setAttr ".cel[1].ep" 0.49000000953674316;
	setAttr ".cel[1].ec" -type "float3" 0.34299999 0.49063885 1 ;
	setAttr ".cel[2].ep" 0.50999999046325684;
	setAttr ".cel[2].ec" -type "float3" 0.93300003 0.93300003 0.93300003 ;
createNode place2dTexture -n "place2dTexture7";
	setAttr ".re" -type "float2" 1 50 ;
createNode volumeNoise -n "volumeNoise2";
	setAttr ".cg" -type "float3" 0.854963 0.854963 0.854963 ;
	setAttr ".co" -type "float3" 0.17557031 0.17557031 0.17557031 ;
	setAttr ".a" 0.82442748546600342;
	setAttr ".dm" 4;
	setAttr ".fq" 90.076332092285156;
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
	setAttr -av -k on ".nds";
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -av -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "PxrBump7.resultN" "PxrLMPlasticPaperRuled.diffuseNn";
connectAttr "PxrBump7.resultN" "PxrLMPlasticPaperRuled.specularNn";
connectAttr "ramp5.oc" "PxrLMPlasticPaperRuled.diffuseColor";
connectAttr "volumeNoise2.oa" "PxrLMPlasticPaperRuled.diffuseRoughness";
connectAttr ":defaultRenderGlobals.msg" "mtorPartition.rgcnx";
connectAttr "PxrWorley1.resultF" "PxrBump7.inputBump";
connectAttr "PxrManifold2D1.result" "PxrWorley1.manifold";
connectAttr "stucco4.oa" "PxrManifold2D1.angle";
connectAttr "place3dTexture11.wim" "stucco4.pm";
connectAttr "place2dTexture7.o" "ramp5.uv";
connectAttr "place2dTexture7.ofs" "ramp5.fs";
connectAttr "place3dTexture12.wim" "volumeNoise2.pm";
connectAttr "PxrLMPlasticPaperRuled.msg" ":defaultShaderList1.s" -na;
