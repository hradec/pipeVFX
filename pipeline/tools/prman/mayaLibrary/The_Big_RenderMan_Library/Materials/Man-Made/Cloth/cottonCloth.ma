...
//Name: cottonCloth.ma
//Last modified: Sun, Feb 15, 2015 04:50:28 AM
//Codeset: 1252
requires maya "2014";
...
createNode place3dTexture -n "place3dTexture15";
	setAttr ".s" -type "double3" 0.4 0.8 1 ;
createNode shadingEngine -n "PxrLMPlasticCottonSG";
	setAttr ".ihi" 0;
	setAttr -s 5 ".dsm";
	setAttr ".ro" yes;
...
createNode PxrLMPlastic -n "PxrLMPlasticCotton";
...
createNode cloth -n "cloth2";
	setAttr ".ao" -0.5;
	setAttr ".vc" -type "float3" 0.7446 0.78249657 0.85000002 ;
	setAttr ".uwi" 0.61654132604598999;
	setAttr ".vwi" 0.61654132604598999;
	setAttr ".uwa" 0.003759398590773344;
	setAttr ".vwa" 0.0040000001899898052;
	setAttr ".r" 0.090225562453269958;
	setAttr ".ws" 0.27067670226097107;
	setAttr ".bs" 0.29323309659957886;
createNode place2dTexture -n "place2dTexture18";
	setAttr ".re" -type "float2" 300 300 ;
createNode PxrBump -n "PxrBump4";
	setAttr ".scale" 0.019999999552965164;
createNode RMSDisplacement -n "RMSDisplacement3";
	setAttr ".sphere" 0.10000000149011612;
	setAttr ".displacementAmount" 0.05000000074505806;
createNode brownian -n "brownian3";
	setAttr ".ail" yes;
	setAttr ".ao" -0.5;
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -av -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "PxrLMPlasticCotton.oc" "PxrLMPlasticCottonSG.ss";
connectAttr "scene:pasted__polySurfaceShape1.iog" "PxrLMPlasticCottonSG.dsm" -na
		;
connectAttr "scene:RoadKillOut3Shape.iog" "PxrLMPlasticCottonSG.dsm" -na;
connectAttr "scene:RoadKillOutShape2.iog" "PxrLMPlasticCottonSG.dsm" -na;
connectAttr "scene:RoadKillOutShape1.iog" "PxrLMPlasticCottonSG.dsm" -na;
connectAttr "scene:RoadKillOutShape.iog" "PxrLMPlasticCottonSG.dsm" -na;
connectAttr "RMSDisplacement3.oc" "PxrLMPlasticCottonSG.ds";
connectAttr ":defaultRenderGlobals.msg" "mtorPartition.rgcnx";
connectAttr "PxrLMPlasticCottonSG.msg" "materialInfo29.sg";
connectAttr "PxrLMPlasticCotton.msg" "materialInfo29.m";
connectAttr "PxrLMPlasticCotton.msg" "materialInfo29.t" -na;
connectAttr "cloth2.oc" "PxrLMPlasticCotton.diffuseColor";
connectAttr "PxrBump4.resultN" "PxrLMPlasticCotton.specularNn";
connectAttr "PxrBump4.resultN" "PxrLMPlasticCotton.diffuseNn";
connectAttr "place2dTexture18.o" "cloth2.uv";
connectAttr "place2dTexture18.ofs" "cloth2.fs";
connectAttr "cloth2.oa" "PxrBump4.inputBump";
connectAttr "brownian3.oa" "RMSDisplacement3.displacementScalar";
connectAttr "place3dTexture15.wim" "brownian3.pm";
relationship "link" ":lightLinker1" ":initialShadingGroup.message" ":defaultLightSet.message";
relationship "link" ":lightLinker1" ":initialParticleSE.message" ":defaultLightSet.message";
relationship "link" ":lightLinker1" "PxrLMPlasticCottonSG.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" ":initialShadingGroup.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" ":initialParticleSE.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" "PxrLMPlasticCottonSG.message" ":defaultLightSet.message";
connectAttr "PxrLMPlasticCottonSG.pa" ":renderPartition.st" -na;
connectAttr "PxrLMPlasticCotton.msg" ":defaultShaderList1.s" -na;
connectAttr "RMSDisplacement3.msg" ":defaultShaderList1.s" -na;
connectAttr "cloth2.msg" ":defaultTextureList1.tx" -na;
connectAttr "brownian3.msg" ":defaultTextureList1.tx" -na;
