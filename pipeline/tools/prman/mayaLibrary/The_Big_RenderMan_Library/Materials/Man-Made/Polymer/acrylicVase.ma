...
//Name: acrylicVase.ma
//Last modified: Sun, Apr 05, 2015 08:19:29 PM
//Codeset: 1252
requires maya "2014";
...
createNode PxrLMDiffuse -n "PxrLMDiffuseAcrylicVase";
	setAttr ".backColor" -type "float3" 0.67415887 0.67415887 0.67415887 ;
	setAttr ".roughness" 1;
	setAttr ".sheen" -type "float3" 0.4269627 0.4269627 0.4269627 ;
...
createNode PxrVary -n "PxrVary1";
	setAttr ".saturation" 1.6000000238418579;
	setAttr ".saturationMode" 1;
createNode PxrVoronoise -n "PxrVoronoise5";
	setAttr ".gain" 1.4384831190109253;
	setAttr ".lacunarity" 8;
	setAttr ".jitter" 1;
	setAttr ".turbulent" yes;
createNode PxrWorley -n "PxrWorley2";
	setAttr ".frequency" 1.348314642906189;
	setAttr ".distancemetric" 2;
	setAttr ".jitter" 1;
	setAttr ".minkowskiExponent" 4.8820223808288574;
	setAttr ".clamp" no;
createNode PxrRemap -n "PxrRemap13";
	setAttr ".clampInput" no;
	setAttr ".bias" -type "float3" 0.79775691 0.79775691 0.79775691 ;
	setAttr ".gain" -type "float3" 0.43820858 0.43820858 0.43820858 ;
	setAttr ".outputMax" 12.764044761657715;
	setAttr ".clampOutput" no;
createNode PxrBump -n "PxrBump10";
	setAttr ".scale" 0.11999999731779099;
createNode PxrLMLayer -n "PxrLMLayer3";
	setAttr ".diffuseBehavior" no;
	setAttr ".specularRoughness" 0.35483145713806152;
	setAttr ".clearcoatBehavior" yes;
	setAttr ".clearcoatColor" -type "float3" 0.74157321 0.74157321 0.74157321 ;
	setAttr ".clearcoatEta" 1.4900000095367432;
	setAttr ".clearcoatThickness" 1;
createNode PxrRemap -n "PxrRemap14";
	setAttr ".outputMin" 0.05000000074505806;
	setAttr ".outputMax" 0.40000000596046448;
	setAttr ".clampOutput" no;
createNode PxrVoronoise -n "PxrVoronoise6";
	setAttr ".frequency" 4.2359552383422852;
	setAttr ".gain" 0.76466292142868042;
	setAttr ".lacunarity" 2.1573033332824707;
	setAttr ".jitter" 1;
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -av -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "PxrVary1.resultRGB" "PxrLMDiffuseAcrylicVase.frontColor";
connectAttr "PxrBump10.resultN" "PxrLMDiffuseAcrylicVase.bumpNormal";
connectAttr "PxrLMLayer3.result" "PxrLMDiffuseAcrylicVase.lmlayer";
connectAttr ":defaultRenderGlobals.msg" "mtorPartition.rgcnx";
connectAttr "PxrVoronoise5.resultF" "PxrVary1.inputRGBr";
connectAttr "PxrVoronoise5.resultF" "PxrVary1.inputRGBg";
connectAttr "PxrVoronoise5.resultF" "PxrVary1.inputRGBb";
connectAttr "PxrRemap13.resultB" "PxrVary1.hue";
connectAttr "PxrWorley2.resultF" "PxrVoronoise5.frequency";
connectAttr "PxrVoronoise5.resultF" "PxrRemap13.inputRGBg";
connectAttr "PxrVoronoise5.resultF" "PxrRemap13.inputRGBr";
connectAttr "PxrVoronoise5.resultF" "PxrRemap13.inputRGBb";
connectAttr "PxrVoronoise5.resultF" "PxrBump10.inputBump";
connectAttr "PxrBump10.resultN" "PxrLMLayer3.specularNn";
connectAttr "PxrRemap14.resultG" "PxrLMLayer3.clearcoatRoughness";
connectAttr "PxrVoronoise6.resultF" "PxrRemap14.inputRGBr";
connectAttr "PxrVoronoise6.resultF" "PxrRemap14.inputRGBg";
connectAttr "PxrVoronoise6.resultF" "PxrRemap14.inputRGBb";
connectAttr "PxrLMDiffuseAcrylicVase.msg" ":defaultShaderList1.s" -na;
connectAttr "PxrVoronoise5.msg" ":defaultTextureList1.tx" -na;
connectAttr "PxrWorley2.msg" ":defaultTextureList1.tx" -na;
connectAttr "PxrVary1.msg" ":defaultTextureList1.tx" -na;
connectAttr "PxrRemap13.msg" ":defaultTextureList1.tx" -na;
connectAttr "PxrBump10.msg" ":defaultTextureList1.tx" -na;
connectAttr "PxrVoronoise6.msg" ":defaultTextureList1.tx" -na;
connectAttr "PxrRemap14.msg" ":defaultTextureList1.tx" -na;
// End of acrylicVase.ma
