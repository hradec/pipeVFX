...
//Name: Plastic_Thermosetting.ma
//Last modified: Sun, Feb 01, 2015 04:19:56 AM
//Codeset: 1252
requires maya "2014";
...
createNode PxrLMPlastic -n "PxrLMPlasticThermoSetting";
	setAttr ".diffuseColor" -type "float3" 0.056000002 0.056000002 0.056000002 ;
	setAttr ".diffuseRoughness" 0.47191011905670166;
	setAttr ".translucence" 0.089887641370296478;
	setAttr ".sheen" -type "float3" 0.74157321 0.74157321 0.74157321 ;
	setAttr ".specularColor" -type "float3" 1 1 1 ;
	setAttr ".specularRoughness" 0.47999998927116394;
	setAttr ".clearcoatColor" -type "float3" 0.221 0.221 0.221 ;
...
createNode PxrBump -n "PxrBump2";
	setAttr ".scale" 0.012000000104308128;
createNode noise -n "noise3";
	setAttr ".ail" yes;
	setAttr ".ag" 0.10000000149011612;
	setAttr ".a" 0.78632479906082153;
	setAttr ".th" 0.17948718369007111;
	setAttr ".dm" 4;
	setAttr ".fq" 17.94871711730957;
	setAttr ".in" yes;
	setAttr ".ti" 0.21367521584033966;
	setAttr ".nty" 0;
createNode place2dTexture -n "place2dTexture10";
	setAttr ".re" -type "float2" 20 20 ;
createNode fractal -n "fractal6";
	setAttr ".an" yes;
createNode place2dTexture -n "place2dTexture11";
createNode fractal -n "fractal7";
	setAttr ".an" yes;
	setAttr ".ti" 14.285714149475098;
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
	setAttr -av -k on ".nds";
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -av -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "PxrBump2.resultN" "PxrLMPlasticThermoSetting.diffuseNn";
connectAttr "PxrBump2.resultN" "PxrLMPlasticThermoSetting.specularNn";
connectAttr "PxrBump2.resultN" "PxrLMPlasticThermoSetting.clearcoatNn";
connectAttr ":defaultRenderGlobals.msg" "mtorPartition.rgcnx";
connectAttr "noise3.oa" "PxrBump2.inputBump";
connectAttr "place2dTexture10.o" "noise3.uv";
connectAttr "place2dTexture10.ofs" "noise3.fs";
connectAttr "fractal6.oa" "place2dTexture10.tfu";
connectAttr "fractal7.oa" "place2dTexture10.tfv";
connectAttr "place2dTexture11.o" "fractal6.uv";
connectAttr "place2dTexture11.ofs" "fractal6.fs";
connectAttr "place2dTexture11.o" "fractal7.uv";
connectAttr "place2dTexture11.ofs" "fractal7.fs";
connectAttr "PxrLMPlasticThermoSetting.msg" ":defaultShaderList1.s" -na;
connectAttr "PxrBump2.msg" ":defaultTextureList1.tx" -na;
connectAttr "noise3.msg" ":defaultTextureList1.tx" -na;
connectAttr "fractal6.msg" ":defaultTextureList1.tx" -na;
connectAttr "fractal7.msg" ":defaultTextureList1.tx" -na;
connectAttr "place2dTexture10.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "place2dTexture11.msg" ":defaultRenderUtilityList1.u" -na;
// End of Plastic_Thermosetting.ma
