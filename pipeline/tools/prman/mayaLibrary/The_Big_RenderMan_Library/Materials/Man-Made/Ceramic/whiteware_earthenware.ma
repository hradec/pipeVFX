...
//Name: whiteware_earthenware.ma
//Last modified: Sun, Feb 15, 2015 08:28:03 PM
//Codeset: 1252
requires maya "2014";
...
createNode place3dTexture -n "place3dTexture27";
	setAttr ".s" -type "double3" 10 0.5 1 ;
createNode PxrLMPlastic -n "PxrLMPlasticTerracota";
	setAttr ".diffuseRoughness" 0.78651684522628784;
	setAttr ".sheen" -type "float3" 0.93800002 0.34542942 0.12662999 ;
	setAttr ".specularRoughness" 0.61797749996185303;
...
createNode stucco -n "stucco1";
	setAttr ".sh" 5.7142858505249023;
	setAttr ".c1" -type "float3" 0.82706952 0.27481499 0.13481346 ;
	setAttr ".c2" -type "float3" 0.61654079 0.1940795 0.12823682 ;
createNode PxrBump -n "PxrBump1";
	setAttr ".scale" 0.10112359374761581;
createNode PxrToFloat -n "PxrToFloat2";
	setAttr ".mode" 4;
createNode PxrBlend -n "PxrBlend1";
	setAttr ".topA" 0.97752809524536133;
createNode noise -n "noise1";
	setAttr ".i" yes;
	setAttr ".ail" yes;
	setAttr ".a" 0.31666666269302368;
	setAttr ".ra" 0.64957267045974731;
	setAttr ".th" 0.62000000476837158;
	setAttr ".dm" 2;
	setAttr ".fq" 94.017097473144531;
	setAttr ".nty" 0;
...
createNode volumeNoise -n "volumeNoise2";
	setAttr ".ail" yes;
	setAttr ".ao" -0.5;
	setAttr ".a" 0.29770991206169128;
	setAttr ".th" 0.16030535101890564;
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
	setAttr -av -k on ".nds";
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -av -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "stucco1.oc" "PxrLMPlasticTerracota.diffuseColor";
connectAttr "PxrBump1.resultN" "PxrLMPlasticTerracota.diffuseNn";
connectAttr "PxrBump1.resultN" "PxrLMPlasticTerracota.specularNn";
connectAttr "volumeNoise2.oc" "PxrLMPlasticTerracota.specularColor";
connectAttr ":defaultRenderGlobals.msg" "mtorPartition.rgcnx";
connectAttr "place3dTexture3.wim" "stucco1.pm";
connectAttr "PxrToFloat2.resultF" "PxrBump1.inputBump";
connectAttr "PxrBlend1.resultRGB" "PxrToFloat2.input";
connectAttr "noise1.oc" "PxrBlend1.topRGB";
connectAttr "noise2.oc" "PxrBlend1.bottomRGB";
connectAttr "place2dTexture4.o" "noise1.uv";
connectAttr "place2dTexture4.ofs" "noise1.fs";
connectAttr "fractal1.oa" "place2dTexture4.tfu";
connectAttr "fractal2.oa" "place2dTexture4.tfv";
connectAttr "place2dTexture6.o" "fractal1.uv";
connectAttr "place2dTexture6.ofs" "fractal1.fs";
connectAttr "place2dTexture6.o" "fractal2.uv";
connectAttr "place2dTexture6.ofs" "fractal2.fs";
connectAttr "place2dTexture4.o" "noise2.uv";
connectAttr "place2dTexture4.ofs" "noise2.fs";
connectAttr "place3dTexture27.wim" "volumeNoise2.pm";
connectAttr "PxrLMPlasticTerracota.msg" ":defaultShaderList1.s" -na;
...
connectAttr "place3dTexture27.msg" ":defaultRenderUtilityList1.u" -na;
// End of whiteware_earthenware.ma
