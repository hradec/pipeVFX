...
//Name: special_paint_fireHydrant.ma
//Last modified: Sun, Feb 01, 2015 04:27:52 AM
//Codeset: 1252
requires maya "2014";
...
createNode shadingEngine -n "fireHydrant:PxrLMFireHydrantSG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode partition -n "mtorPartition";
	...
	setAttr ".sr" -type "string" (
		...
		+ "TransformEnd\nIfEnd\n}}\n");
createNode materialInfo -n "fireHydrant:materialInfo27";
createNode PxrLMPlastic -n "fireHydrant:PxrLMFireHydrant";
	setAttr ".diffuseColor" -type "float3" 0.528 0.1065504 0.041711997 ;
	setAttr ".diffuseRoughness" 0.33707866072654724;
	setAttr ".specularColor" -type "float3" 0.67415887 0.67415887 0.67415887 ;
	setAttr ".specularRoughness" 0.24719101190567017;
createNode PxrBump -n "fireHydrant:PxrBump8";
	setAttr ".scale" 0.0099999997764825821;
createNode PxrToFloat -n "fireHydrant:PxrToFloat6";
createNode PxrBlend -n "fireHydrant:PxrBlend3";
createNode PxrRemap -n "fireHydrant:PxrRemap4";
	setAttr ".inputMin" 0.40000000596046448;
	setAttr ".bias" -type "float3" 0.10112154 0.10112154 0.10112154 ;
	setAttr ".gain" -type "float3" 0.92135501 0.92135501 0.92135501 ;
createNode PxrFractal -n "fireHydrant:PxrFractal6";
	setAttr ".layers" 4;
	setAttr ".frequency" 12;
	setAttr ".lacunarity" 2.1460673809051514;
	setAttr ".dimension" 0.31460675597190857;
	setAttr ".erosion" 1.685393214225769;
	setAttr ".variation" 0.49438202381134033;
createNode PxrManifold2D -n "PxrManifold2D6";
	setAttr ".scaleS" 5;
	setAttr ".scaleT" 5;
createNode PxrVoronoise -n "fireHydrant:PxrVoronoise4";
	setAttr ".frequency" 120;
	setAttr ".gain" 0.0010000000474974513;
	setAttr ".lacunarity" 4.134831428527832;
	setAttr ".jitter" 0.089887641370296478;
createNode PxrManifold2D -n "fireHydrant:PxrManifold2D4";
	setAttr ".angle" 238.65168762207031;
	setAttr ".scaleS" 2;
	setAttr ".scaleT" 10;
createNode RMSDisplacement -n "fireHydrant:RMSDisplacement4";
	setAttr ".displacementAmount" 0.014000000432133675;
createNode PxrToFloat -n "fireHydrant:PxrToFloat5";
	setAttr ".mode" 3;
createNode PxrClamp -n "fireHydrant:PxrClamp4";
	setAttr ".max" -type "float3" 0.9662928 0.9662928 0.9662928 ;
createNode PxrRemap -n "fireHydrant:PxrRemap3";
	setAttr ".bias" -type "float3" 0.73034257 0.73034257 0.73034257 ;
	setAttr ".gain" -type "float3" 0.28090334 0.28090334 0.28090334 ;
createNode PxrBlend -n "fireHydrant:PxrBlend2";
	setAttr ".topRGB" -type "float3" 0.921 0.921 0.921 ;
createNode PxrVoronoise -n "fireHydrant:PxrVoronoise3";
	setAttr ".frequency" 6.6629214286804199;
	setAttr ".gain" 1;
	setAttr ".lacunarity" 2.3370785713195801;
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -av -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "fireHydrant:PxrLMFireHydrant.oc" "fireHydrant:PxrLMFireHydrantSG.ss"
		;
connectAttr "fireHydrant:RMSDisplacement4.oc" "fireHydrant:PxrLMFireHydrantSG.ds"
		;
connectAttr ":defaultRenderGlobals.msg" "mtorPartition.rgcnx";
connectAttr "fireHydrant:PxrLMFireHydrantSG.msg" "fireHydrant:materialInfo27.sg"
		;
connectAttr "fireHydrant:PxrLMFireHydrant.msg" "fireHydrant:materialInfo27.m";
connectAttr "fireHydrant:PxrLMFireHydrant.msg" "fireHydrant:materialInfo27.t" -na
		;
connectAttr "fireHydrant:PxrBump8.resultN" "fireHydrant:PxrLMFireHydrant.diffuseNn"
		;
connectAttr "fireHydrant:PxrBump8.resultN" "fireHydrant:PxrLMFireHydrant.specularNn"
		;
connectAttr "fireHydrant:PxrToFloat6.resultF" "fireHydrant:PxrBump8.inputBump";
connectAttr "fireHydrant:PxrBlend3.resultRGB" "fireHydrant:PxrToFloat6.input";
connectAttr "fireHydrant:PxrRemap4.resultR" "fireHydrant:PxrBlend3.topA";
connectAttr "fireHydrant:PxrRemap4.resultRGB" "fireHydrant:PxrBlend3.topRGB";
connectAttr "fireHydrant:PxrVoronoise4.resultF" "fireHydrant:PxrBlend3.topRGBr";
connectAttr "fireHydrant:PxrVoronoise4.resultF" "fireHydrant:PxrBlend3.topRGBg";
connectAttr "fireHydrant:PxrVoronoise4.resultF" "fireHydrant:PxrBlend3.topRGBb";
connectAttr "fireHydrant:PxrFractal6.resultF" "fireHydrant:PxrRemap4.inputRGBr";
connectAttr "fireHydrant:PxrFractal6.resultF" "fireHydrant:PxrRemap4.inputRGBg";
connectAttr "fireHydrant:PxrFractal6.resultF" "fireHydrant:PxrRemap4.inputRGBb";
connectAttr "PxrManifold2D6.result" "fireHydrant:PxrFractal6.manifold";
connectAttr "fireHydrant:PxrManifold2D4.result" "fireHydrant:PxrVoronoise4.manifold"
		;
connectAttr "fireHydrant:PxrToFloat5.resultF" "fireHydrant:RMSDisplacement4.displacementScalar"
		;
connectAttr "fireHydrant:PxrClamp4.resultRGB" "fireHydrant:PxrToFloat5.input";
connectAttr "fireHydrant:PxrRemap3.resultRGB" "fireHydrant:PxrClamp4.inputRGB";
connectAttr "fireHydrant:PxrBlend2.resultRGB" "fireHydrant:PxrRemap3.inputRGB";
connectAttr "fireHydrant:PxrVoronoise3.resultF" "fireHydrant:PxrBlend2.topA";
relationship "link" ":lightLinker1" ":initialShadingGroup.message" ":defaultLightSet.message";
relationship "link" ":lightLinker1" ":initialParticleSE.message" ":defaultLightSet.message";
relationship "link" ":lightLinker1" "fireHydrant:PxrLMFireHydrantSG.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" ":initialShadingGroup.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" ":initialParticleSE.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" "fireHydrant:PxrLMFireHydrantSG.message" ":defaultLightSet.message";
connectAttr "fireHydrant:PxrLMFireHydrantSG.pa" ":renderPartition.st" -na;
connectAttr "fireHydrant:PxrLMFireHydrant.msg" ":defaultShaderList1.s" -na;
connectAttr "fireHydrant:RMSDisplacement4.msg" ":defaultShaderList1.s" -na;
connectAttr "fireHydrant:PxrVoronoise3.msg" ":defaultTextureList1.tx" -na;
connectAttr "fireHydrant:PxrBlend2.msg" ":defaultTextureList1.tx" -na;
connectAttr "fireHydrant:PxrRemap3.msg" ":defaultTextureList1.tx" -na;
connectAttr "fireHydrant:PxrBump8.msg" ":defaultTextureList1.tx" -na;
connectAttr "fireHydrant:PxrToFloat5.msg" ":defaultTextureList1.tx" -na;
connectAttr "fireHydrant:PxrVoronoise4.msg" ":defaultTextureList1.tx" -na;
connectAttr "fireHydrant:PxrBlend3.msg" ":defaultTextureList1.tx" -na;
connectAttr "fireHydrant:PxrFractal6.msg" ":defaultTextureList1.tx" -na;
connectAttr "fireHydrant:PxrRemap4.msg" ":defaultTextureList1.tx" -na;
connectAttr "fireHydrant:PxrToFloat6.msg" ":defaultTextureList1.tx" -na;
connectAttr "fireHydrant:PxrClamp4.msg" ":defaultTextureList1.tx" -na;
// End of special_paint_fireHydrant.ma
