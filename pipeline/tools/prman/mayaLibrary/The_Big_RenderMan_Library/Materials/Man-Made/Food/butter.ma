...
//Name: butter.ma
//Last modified: Tue, Mar 17, 2015 03:17:30 AM
//Codeset: 1252
requires maya "2014";
...
createNode PxrLMPlastic -n "PxrLMPlasticButter";
	setAttr ".diffuseColor" -type "float3" 1 0.92950332 0.60100001 ;
	setAttr ".diffuseRoughness" 0.02247191034257412;
	setAttr ".translucence" 0.33000001311302185;
	setAttr ".sheen" -type "float3" 0.15730526 0.15730526 0.15730526 ;
	setAttr ".specularColor" -type "float3" 0.43820858 0.43820858 0.43820858 ;
	setAttr ".specularRoughness" 0.46067416667938232;
	setAttr ".clearcoatColor" -type "float3" 0.786511 0.786511 0.786511 ;
	setAttr ".clearcoatRoughness" 0.14348314702510834;
...
createNode fractal -n "fractal7";
	setAttr ".ail" yes;
	setAttr ".ao" -0.5;
	setAttr ".lmx" 0.85470086336135864;
createNode place2dTexture -n "place2dTexture6";
	setAttr ".re" -type "float2" 6 1 ;
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
	setAttr -av -k on ".nds";
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -av -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "PxrBump3.resultN" "PxrLMPlasticButter.diffuseNn";
connectAttr "PxrBump3.resultN" "PxrLMPlasticButter.specularNn";
connectAttr "PxrBump3.resultN" "PxrLMPlasticButter.clearcoatNn";
connectAttr ":defaultRenderGlobals.msg" "mtorPartition.rgcnx";
connectAttr "fractal7.oa" "PxrBump3.inputBump";
connectAttr "place2dTexture6.o" "fractal7.uv";
connectAttr "place2dTexture6.ofs" "fractal7.fs";
connectAttr "PxrLMPlasticButter.msg" ":defaultShaderList1.s" -na;
